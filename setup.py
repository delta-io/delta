...
# Support the three Spark 4.x lines while retaining the existing importlib_metadata upper bound.
install_requires_arg = ['pyspark>=4.0.1,<4.3.0', 'importlib_metadata>=1.0.0,<=8.7.1']
