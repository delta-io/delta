...
description: Learn how to use row tracking to track row-level lineage in Delta Lake tables
---
...
<Aside type="caution">
  ...
  compatibility?](/latest/apache-spark-connector/how-does-delta-lake-manage-feature-compatibility/).
</Aside>
...
- The row ids and row commit versions metadata fields cannot be accessed while reading the [Change data feed](/latest/apache-spark-connector/change-data-feed/).
