---
title: Constraints
description: Learn how to use constraints in Delta Lake tables to ensure data quality and integrity
---
...
>
  ...
  compatibility?](/latest/apache-spark-connector/how-does-delta-lake-manage-feature-compatibility/) to understand table protocol
  versioning and what it means to upgrade the protocol version.
</Aside>
