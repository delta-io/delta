---
title: Optimizations
description: Learn about Delta Lake optimizations that accelerate data lake operations
---
...
For Scala, Java, and Python API syntax details, see the [Delta Lake APIs](/latest/delta-lake-apis/).
...
<Image src={import('./optimized-writes.png')} alt="Optimized writes" />
