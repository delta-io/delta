...
public class IcebergWriterCompatV3MetadataValidatorAndUpdater
  ...
  private static final IcebergCompatRequiredTablePropertyEnforcer CM_ID_MODE_ENABLED =
      new IcebergCompatRequiredTablePropertyEnforcer<>(
          ...
          // name is correctly set as part of icebergWriterCompatV3 checks
          (inputContext) ->
  ...
  private static final IcebergCompatCheck UNSUPPORTED_FEATURES_CHECK =
      (inputContext) -> {
        ...
        //   for blocking enablement of icebergWriterCompatV3 versus enablement of the incompatible
        //   feature
   ...
   * {@link ShortType} are unsupported for IcebergWriterCompatV3 tables.
   */
