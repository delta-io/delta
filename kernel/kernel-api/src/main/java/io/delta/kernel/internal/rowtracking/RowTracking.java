...
public class RowTracking {
  /** The default name of the row ID column that kernel assigns when requesting row ID values. */
  private static final String DEFAULT_ROW_ID_NAME = "_metadata.row_id";

  /**
   * The default name of the row commit version column that kernel assigns when requesting row
   * commit version values.
   */
  private static final String DEFAULT_ROW_COMMIT_VERSION_NAME = "_metadata.row_commit_version";

  public static StructField ROW_ID =
      new StructField(DEFAULT_ROW_ID_NAME, MetadataType.ROW_ID, false);

  public static StructField ROW_COMMIT_VERSION =
      new StructField(DEFAULT_ROW_COMMIT_VERSION_NAME, MetadataType.ROW_COMMIT_VERSION, false);
  ...
  public static boolean isRowTrackingColumn(StructField field) {
    return field.getDataType().equals(MetadataType.ROW_ID)
        || field.getDataType().equals(MetadataType.ROW_COMMIT_VERSION);
  }
