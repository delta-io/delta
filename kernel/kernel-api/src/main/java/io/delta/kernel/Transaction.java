...
public interface Transaction {
  ...
  void setInitialDataActions(Engine engine, CloseableIterable<Row> dataActions);

  CloseableIterator<Row> getFinalizedActions(Engine engine);
  ...
  TransactionCommitResult registerCommitSuccess(long commitVersion);
