...
public interface Snapshot {
   ...
   *
   * <p>The checkpoint is generated by materializing the snapshot state and persisting it using the
   * provided {@code engine}. The implementation may read the transaction log as part of checkpoint
   * computation.
   *
