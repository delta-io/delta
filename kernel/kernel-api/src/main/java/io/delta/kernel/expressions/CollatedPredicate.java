...
/**
 * Defines {@link CollatedPredicate} which is an extension of {@link Predicate} that evaluates to
 * true, false, or null for each input row using specified collation. <br>
 * <br>
 * Examples:
 *
 * <ol>
 *   <li><code>expr1 = expr2 COLLATE "SPARK.UTF8_LCASE"</code>
 *   <li><code>expr1 <= expr2 COLLATE "ICU.sr_Cyrl_SRB.75.1"</code>
