...
package io.delta.kernel.catalogmanaged;
...
public class CatalogManagedUtils {
  ...
  public static String getStagedCommitFilePath(String logPath, long version) {
    return FileNames.stagedCommitFile(new Path(logPath), version);
  }
}
