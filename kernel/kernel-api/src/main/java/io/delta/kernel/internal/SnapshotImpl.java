...
public class SnapshotImpl implements Snapshot {
     ...
     */
    public Optional<Long> getLatestTransactionVersion(String applicationId, Engine engine) {
        return logReplay.getLatestTransactionIdentifier(applicationId, engine);
    }
