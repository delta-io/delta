...
public class TransactionImpl
    ...
    public TransactionImpl(
        ...
        this.clock = clock;
        this.shouldUpdateMetadata = false;
    }
        ...
        try {
            ...
            do {
                ...
                try {
                    ...
                    Optional<Long> updatedCommitTimestamp = getUpdatedCommitTimestampAfterConflict(
                    ...
                    if (updatedCommitTimestamp.isPresent()) {
                        Optional<Metadata> metadataWithICTInfo = getUpdatedMetadataAfterConflict(
                                engine,
                                updatedCommitTimestamp.get(),
                                metadata,
                                rebaseState.getLatestVersion()
                        );
                        metadataWithICTInfo.ifPresent(this::updateMetadata);
                    }
                    attemptCommitInfo.setInCommitTimestamp(updatedCommitTimestamp);
                }
                numRetries++;
    ...
    private CommitInfo generateCommitAction(Engine engine) {
        ...
        return new CommitInfo(
                generateInCommitTimestampForFirstCommitAttempt(
                        engine, commitAttemptStartTime), /* inCommitTimestamp */
