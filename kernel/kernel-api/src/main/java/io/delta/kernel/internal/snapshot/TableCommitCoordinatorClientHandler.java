...
public class TableCommitCoordinatorClientHandler {
    ...
    public GetCommitsResponse getCommits(Long startVersion, Long endVersion) {
        return commitCoordinatorClientHandler.getCommits(
                logPath, tableConf, startVersion, endVersion);
    }
    ...
    public boolean semanticEquals(
            TableCommitCoordinatorClientHandler otherCommitCoordinatorClient) {
