 ...
 * {@link Transaction#commitWithRetries(TableClient, CloseableIterable, int)}.
 *
 * @since 3.2.0
 */
@Evolving
public class TransactionCommitStatus {
    ...
    public TransactionCommitStatus(long version, boolean isReadyForCheckpoint) {
     ...
     * using {@link Table#checkpoint(TableClient, long)}
     *
