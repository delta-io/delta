...
public class IcebergCompatV3MetadataValidatorAndUpdater
  ...
  private static final IcebergCompatCheck ICEBERG_COMPAT_V3_CHECK_NO_COMPAT_V1_ENABLED =
      (inputContext) -> {
        if (Boolean.valueOf(
            inputContext
                .newMetadata
  ...
  private static final IcebergCompatCheck ICEBERG_COMPAT_V3_CHECK_NO_COMPAT_V2_ENABLED =
      (inputContext) -> {
        if (Boolean.valueOf(
            inputContext
                .newMetadata
          ...
          throw DeltaErrors.icebergCompatIncompatibleVersionEnabled(
              INSTANCE.compatFeatureName(), "delta.enableIcebergCompatV2");
        }
      };
      ...
      (inputContext) -> {
        ...
        for (SchemaIterable.SchemaElement element :
          ...
          for (TypeChange typeChange : element.getField().getTypeChanges()) {
            if (!TypeWideningChecker.isIcebergV3Compatible(
  ...
  List<IcebergCompatCheck> icebergCompatChecks() {
    return Stream.of(
            ICEBERG_COMPAT_V3_CHECK_NO_COMPAT_V1_ENABLED,
            ICEBERG_COMPAT_V3_CHECK_NO_COMPAT_V2_ENABLED,
