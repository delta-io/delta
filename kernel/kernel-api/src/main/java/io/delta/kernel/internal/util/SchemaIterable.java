...
public class SchemaIterable implements Iterable<SchemaIterable.SchemaElement> {
   ...
   *
   * <p>Consuming multiple iterators across differrent threads concurrently is not thread safe.
   */
  ...
  public interface SchemaElement {
     ...
     *
     * <p>Otherwise the grammar of the returned field is:
  ...
  private abstract static class SchemaZipper implements MutableSchemaElement {
    ...
    public boolean hasChildren() {
      boolean isPrimitive = currentField().getDataType() instanceof BasePrimitiveType;
      ...
      return !isPrimitive && !isEmptyStruct;
    }
