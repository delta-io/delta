...
public class ParsedChecksumData extends ParsedLogData {
  ...
  public static ParsedChecksumData forInlineChecksum(long version, ColumnarBatch inlineData) {
  ...
  private ParsedChecksumData(
    ...
    super(version, ParsedLogType.CHECKSUM, fileStatusOpt, inlineDataOpt);
  }
}
