...
public class CollationFactory {
  ...
  public static Collation fetchCollation(CollationIdentifier collationIdentifier) {
    ...
    if (collationIdentifier.equals(CollationIdentifier.DEFAULT_COLLATION_IDENTIFIER)) {
      ...
      if (collationIdentifier.getProvider().equals(CollationIdentifier.PROVIDER_SPARK)) {
        collation = buildSparkCollation(collationIdentifier);
      } else if (collationIdentifier.getProvider().equals(PROVIDER_ICU)) {
        collation = buildICUCollation(collationIdentifier);
      } else {
  ...
  private static Collation buildSparkCollation(CollationIdentifier collationIdentifier) {
    if (collationIdentifier.equals(CollationIdentifier.DEFAULT_COLLATION_IDENTIFIER)) {
  ...
  private static Collation buildICUCollation(CollationIdentifier collationIdentifier) {
  ...
  public static class Collation {
    ...
    public static Collation DEFAULT_COLLATION = buildSparkCollation(CollationIdentifier.DEFAULT_COLLATION_IDENTIFIER);
