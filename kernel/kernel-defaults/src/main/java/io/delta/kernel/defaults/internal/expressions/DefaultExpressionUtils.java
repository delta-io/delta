...
class DefaultExpressionUtils {
    ...
    static ColumnVector comparatorVector(
            ...
            ColumnVector right,
            IntPredicate booleanComparator) {
        IntPredicate vectorValueComparator = getComparator(
                left, right, booleanComparator);
        return new ColumnVector() {
    ...
    /**
     * Utility method to create a null safe column vector that lazily evaluate the
     * comparator ex. (ie. <=>) for left and right
     * column vector according to the natural ordering of numbers
     * <p>
     * Only primitive data types are supported.
    ...
    static ColumnVector nullSafeComparatorVector(
        ...
        return new ColumnVector() {
            ...
            /**
             * Null safe comparator follows the truth table in Comparison Operators
             *     part of following link
             * https://spark.apache.org/docs/latest/sql-ref-null-semantics.html
             *
             * If either left or right is null, return false
             * If both left and right is null, return true
             * else compare the non null value of left and right
             *
             * @param rowId
             * @return
             */
