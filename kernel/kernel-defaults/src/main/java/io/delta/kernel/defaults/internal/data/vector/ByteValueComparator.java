...
public class ByteValueComparator implements ValueComparator {
    ColumnVector v1;
    ColumnVector v2;
    VectorComparator vectorComparator;

    public ByteValueComparator(ColumnVector v1, ColumnVector v2, VectorComparator vectorComparator) {
        this.v1 = v1;
        this.v2 = v2;
    ...
    public boolean getCompareResult(int rowId) {
        return vectorComparator.compare(Byte.compare(v1.getByte(rowId), v2.getByte(rowId)));
    }
}
