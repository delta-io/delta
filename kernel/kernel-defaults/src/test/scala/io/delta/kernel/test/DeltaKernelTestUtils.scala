 ...
 * when using published delta-spark versions.
 */
object DeltaKernelTestUtils {
   ...
   */
  implicit class OptimisticTxnKernelHelper(txn: OptimisticTransaction) {

    /**
     * Custom implementation of commitManually for testing purposes
     * Uses public APIs to commit transactions manually
     */
