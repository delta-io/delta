...
class LogReplayMetricsSuite extends AnyFunSuite with TestUtils {

  /////////////////////////
  // Test Helper Methods //
  /////////////////////////

  private def withTempDirAndEngine(f: (String, MetricsEngine) => Unit): Unit = {
