...
import io.delta.kernel.{ResolvedTable, ScanBuilder}
import io.delta.kernel.internal.SnapshotImpl
import io.delta.kernel.types.StructType

trait AbstractTestResolvedTable {
  def getPath(): String
  def getVersion(): Long
...
class SnapshotTestAdapter(snapshot: SnapshotImpl) extends AbstractTestResolvedTable {
...
class ResolvedTableTestAdapter(rt: ResolvedTable) extends AbstractTestResolvedTable {
