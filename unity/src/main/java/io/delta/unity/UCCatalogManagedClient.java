...
public class UCCatalogManagedClient {
   ...
   * metadata.
   */
  private static final String CATALOG_MANAGED_ENABLEMENT_PROPERTY =
   ...
   * @return A configured {@link CreateTableTransactionBuilder} for UC managed tables.
   */
  ...
  private Map<String, String> getRequiredTablePropertiesForCreate(String ucTableId) {
    ...
    requiredProperties.put(
        CATALOG_MANAGED_ENABLEMENT_PROPERTY, TableFeatures.SET_TABLE_FEATURE_SUPPORTED_VALUE);

    // TODO: use the ucTableId
