...
public class ExceptionUtils {
  ...
  /**
   * Creates a predicate that applies the given predicate recursively to an exception
   * and its causal chain.
   *
   * <p>The returned predicate returns {@code true} if the supplied predicate matches
   * the exception itself or any of its causes.</p>
   *
