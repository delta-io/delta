...
/**
 * Flink {@link org.apache.flink.table.catalog.Catalog} implementation backed by Unity Catalog.
 * Delegates schema and table operations to {@link UnityCatalog}. Mutation operations (CREATE, DROP,
 * ALTER) are not supported and should be performed directly in UC.
 */
public class FlinkUnityCatalog extends AbstractCatalog {
  ...
  public CatalogBaseTable getTable(ObjectPath tablePath)
    ...
    try {
      // TODO remove token from the object
