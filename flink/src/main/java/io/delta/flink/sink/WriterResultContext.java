...
/**
 * Include the following information collected during writing parquet files - High/Low watermark:
 * the highest and lowest watermark encountered when writing this result
 */
