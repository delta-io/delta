 ...
 * DeltaSink}. Supports both Hadoop-based and Unity Catalog-managed tables.
 */
public class DeltaDynamicTableSink implements DynamicTableSink, SupportsPartitioning {
  ...
  public SinkRuntimeProvider getSinkRuntimeProvider(Context context) {
    ...
    if (options.containsKey(TABLE_PATH.key())) {
      ...
      deltaSink =
          DeltaSink.builder()
              ...
              .withConfigurations(Map.of("type", "hadoop"))
      ...
      deltaSink =
          DeltaSink.builder()
              ...
              .withConfigurations(
                  Map.of(
                      "type", "unitycatalog",
                      "unitycatalog.name", tableId.getCatalogName(),
    ...
    // space to suffix.
    String tableStr = deltaSink.getTable().getId();
    String name =
        options.getOrDefault(NAME.key(), tableStr.substring(0, Math.min(tableStr.length(), 60)));
