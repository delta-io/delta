...
public class VersionHelper {
  ...
  public static Map<String, String> appVersions() {
    ...
    Package flinkSinkPkg = io.delta.flink.table.DeltaTable.class.getPackage();
    String flinkSinkVersion = flinkSinkPkg.getImplementationVersion();
    return Map.of(
        "flink",
        Objects.toString(flinkVersion, "unknown"),
        "delta-kernel",
        Objects.toString(kernelVersion, "unknown"),
        "flink-sink",
        Objects.toString(flinkSinkVersion, "unknown"));
  }
}
