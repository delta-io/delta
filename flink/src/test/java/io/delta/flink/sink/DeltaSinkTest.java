...
/** JUnit test suite for {@link DeltaSink}. */
public class DeltaSinkTest extends TestHelper {
  ...
  void testSinkBuilder() {
    ...
    withTempDir(
        dir ->
            MockHttp.withMock(
                MockHttp.forNewUCTable(
                    "11111111-1111-1111-1111-111111111111", dir.getAbsolutePath()),
                mockHttp -> {
                  DeltaSink sink2 =
                      DeltaSink.builder()
                          .withFlinkSchema(flinkSchema)
