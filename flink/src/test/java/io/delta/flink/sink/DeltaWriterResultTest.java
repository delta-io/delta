...
/** JUnit 6 test suite for DeltaWriterResult serialization and deserialization. */
class DeltaWriterResultTest extends TestHelper {
  ...
  void testSerializeAndDeserialize() throws IOException {
    ...
    DeltaWriterResult origin = new DeltaWriterResult(actions, new WriterResultContext());

    DeltaWriterResult.Serializer serde = new DeltaWriterResult.Serializer();
    DeltaWriterResult deserialized = serde.deserialize(1, serde.serialize(origin));
