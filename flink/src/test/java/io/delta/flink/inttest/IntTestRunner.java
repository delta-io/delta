...
/**
 * IntTest runner that runs the test against an UnityCatalog server. TODO Migrate to
 * UCDeltaTableIntegrationBaseTest once it supports writing columns to Catalog.
 *
