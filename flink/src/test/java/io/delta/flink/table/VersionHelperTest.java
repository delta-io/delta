...
public class VersionHelperTest {
  ...
  public void testAppVersion() {
    ...
    String flinkSinkVersion = Objects.toString(flinkSinkPkg.getImplementationVersion(), "unknown");
    assertEquals(
        Map.of(
            "delta-kernel", kernelVersion, "flink", flinkVersion, "flink-sink", flinkSinkVersion),
        result);
  }
}
