...
public class GetCommitsFromLoadTableResponse extends GetCommitsResponse {
  ...
  public GetCommitsFromLoadTableResponse(
      List<Commit> commits,
  ...
  @Override
  public GetCommitsFromLoadTableResponse sortCommitsByVersion() {
    List<Commit> sorted = new ArrayList<>(getCommits());
    sorted.sort(Comparator.comparingLong(Commit::getVersion));
    return new GetCommitsFromLoadTableResponse(sorted, getLatestTableVersion(), uniformMetadata);
  }
}
