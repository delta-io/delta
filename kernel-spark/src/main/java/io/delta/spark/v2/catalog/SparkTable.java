 ...
 */
package io.delta.spark.v2.catalog;

import static io.delta.spark.v2.utils.ScalaUtils.toScalaMap;
import static java.util.Objects.requireNonNull;

import io.delta.kernel.Snapshot;
import io.delta.spark.v2.read.SparkScanBuilder;
import io.delta.spark.v2.snapshot.DeltaSnapshotManager;
import io.delta.spark.v2.snapshot.PathBasedSnapshotManager;
import io.delta.spark.v2.utils.SchemaUtils;
import java.util.*;
