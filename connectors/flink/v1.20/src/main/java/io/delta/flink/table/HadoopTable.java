...
/**
 * A {@code HadoopTable} is a {@link DeltaTable} implementation backed by a Hadoop-compatible file
 * system. This implementation loads and manages Delta table metadata directly from the underlying
 * storage layer rather than from an external catalog service.
 *
