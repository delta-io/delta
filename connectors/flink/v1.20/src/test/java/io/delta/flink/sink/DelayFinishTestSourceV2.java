...
public class DelayFinishTestSourceV2<T> implements Source<T, DelayFinishTestSourceV2.DFTSplit, Void> {
    ...
    @Override
    public SplitEnumerator<DFTSplit, Void> createEnumerator(SplitEnumeratorContext<DFTSplit> enumContext) throws Exception {
        return null;
    }

    @Override
    public SplitEnumerator<DFTSplit, Void> restoreEnumerator(SplitEnumeratorContext<DFTSplit> enumContext, Void checkpoint) throws Exception {
        return null;
    }
    ...
    @Override
    public SourceReader<T, DFTSplit> createReader(SourceReaderContext readerContext) throws Exception {
        return null;
    }
    ...
    public static class DFTSplitEnumerator
            implements SplitEnumerator<DFTSplit, Void> {
