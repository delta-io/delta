                ...
                field -> {
                  ...
                  if (fieldIdLong == null) {
                    throw new IllegalArgumentException(
                        "Field metadata does not contain a column mapping ID");
                  }
                  int fieldId = fieldIdLong.intValue();
                  return Types.NestedField.optional(
                      fieldId, field.getName(), toIcebergType(field.getName(), field));
                })
  ...
  private static Type toIcebergType(String path, StructField field) {
    ...
    if (deltaType instanceof BooleanType) {
      ...
      if (nestedFieldIds == null) {
        throw new IllegalArgumentException(
            "Field metadata does not contain nested column mapping IDs");
      }
