...
// Matt Powers manually copied this line into this file from here: https://github.com/apache/spark/blob/bc75ed675b0d0bbd9d94d4b33a70e8db74ac95a0/core/src/main/scala/org/apache/spark/rpc/RpcEndpointRef.scala#L111
class RpcAbortException(message: String) extends Exception(message)
// this file too from here: https://github.com/apache/spark/blob/master/core/src/main/scala/org/apache/spark/util/SparkFatalException.scala
class SparkFatalException(val throwable: Throwable) extends Exception
