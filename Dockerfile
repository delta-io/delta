...
RUN pip3 install https://dist.apache.org/repos/dist/dev/spark/v4.0.0-preview1-rc3-bin/pyspark-4.0.0.dev1.tar.gz

RUN pip3 install mypy==1.8.0
...
RUN pip3 install setuptools==41.1.0
