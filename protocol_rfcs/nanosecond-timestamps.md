...
> This feature introduces two new data types to support timestamps with nanosecond resolution. One UTC, one without a timezone corresponding to `TimestampNtz`. For example: `1970-01-01T00:00:00.123456789Z` and `1970-01-01 00:00:00.123456789`, respectively.
...
> nanosecond timestamp: Timestamps should encoded as an ISO8601 formatted timestamp adjusted to UTC timestamp such as `1970-01-01T00:00:00.123456789Z`. They may also be encoded as `{year}-{month}-{day} {hour}:{minute}:{second}.{nanosecond}`, for example: `1970-01-01 00:00:00.123456789`.
