...
```
- The tags of AddFile action that represents a partitioned iceberg DataFile contain "ICEBERG_PARTITION_SPEC_ID", with value being the iceberg partition spec id (Integer), and "ICEBERG_PARTITION_DATA", with value being a JSON array of Base64 encoded string from ByteBuffer of iceberg partition values.
