...
import org.apache.spark.sql.delta.{DeltaCDCStreamDeletionVectorSuite, DeltaCDCStreamSuite, DeltaConfigs, DeltaLog, DeltaOperations}
...
/**
 * Test suite that runs DeltaCDCStreamDeletionVectorSuite using the V2 connector
 * (V2_ENABLE_MODE=STRICT).
 */
class DeltaV2CDCStreamDeletionVectorSuite
    extends DeltaCDCStreamDeletionVectorSuite with V2ForceTest {
