...
import io.delta.storage.commit.{CommitCoordinatorClient => JCommitCoordinatorClient, GetCommitsFromLoadTableResponse, GetCommitsResponse}
...
trait WriteDeltaUCCCReadIceberg extends UniFormE2ETest
  ...
  private class InMemoryUCCommitCoordinatorWithUniForm extends InMemoryUCCommitCoordinator {
    override def getCommitsFromCoordinator(
      ...
      new GetCommitsFromLoadTableResponse(
        base.getCommits,
