    ...
    for test_file in test_files:
        try:
            cmd = ["spark-submit",
                   ...
                   "--packages", package + ",io.delta:delta-connect-server_2.13:4.0.0-SNAPSHOT,io.delta:delta-connect-common_2.13:4.0.0-SNAPSHOT,org.apache.spark:spark-connect_2.13:4.0.0-preview1", test_file]
