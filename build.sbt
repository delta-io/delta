...
lazy val connectClient = (project in file("spark-connect/client"))
  ...
  .settings(
    ...
    (Test / resourceGenerators) += Def.task {
      val src = url("https://repository.apache.org/content/groups/snapshots/org/apache/spark/spark-connect_2.13/4.0.0-SNAPSHOT/spark-connect_2.13-4.0.0-20240603.001517-268.jar")
