...
// ============================================================
// Global settings (import common values from CommonSettings)
// ============================================================
...
// ============================================================
// Kernel Modules - defined in project/KernelModule.scala
// ============================================================
lazy val kernelApi = KernelModule.kernelApi
lazy val kernelDefaults = KernelModule.kernelDefaults
lazy val kernelUnityCatalog = KernelModule.kernelUnityCatalog
lazy val kernelBenchmarks = KernelModule.kernelBenchmarks
lazy val kernelGroup = KernelModule.kernelGroup
...
// Note: skipReleaseSettings, javaOnlyReleaseSettings, and releaseSettings
// are imported from CommonSettings
