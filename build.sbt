...
val targetJavaVersion = settingKey[Int]("Target Java version for generated bytecodes")
Global / targetJavaVersion := DEFAULT_JAVA_VERSION  // default Java version of all modules
...
lazy val commonSettings = Seq(
  ...
  javacOptions ++= getJavacOptionForTargetJavaVersion(name.value, targetJavaVersion.value),
...
def crossSparkSettings(): Seq[Setting[_]] = getSparkVersion() match {
  case LATEST_RELEASED_SPARK_VERSION => Seq(
    scalaVersion := default_scala_version.value,
    crossScalaVersions := all_scala_versions,
    targetJavaVersion := JAVA_VERSION_FOR_LATEST_RELEASED_SPARK,
  ...
  case SPARK_MASTER_VERSION => Seq(
    ...
    targetJavaVersion := JAVA_VERSION_FOR_SPARK_MASTER,
