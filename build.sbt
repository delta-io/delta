...
lazy val connectorsGroup = project
  .aggregate(
    hive, hiveAssembly, hiveTest, hiveMR, hiveTez, hive2MR, hive2Tez, flink, standalone,
    standaloneCosmetic, standaloneWithoutParquetUtils, standaloneParquet, testStandaloneCosmetic)
  .settings(
    // crossScalaVersions must be set to Nil on the aggregating project
    crossScalaVersions := Nil,
    publishArtifact := false,
