...
import spark.connect.common_pb2
...
class Plan(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["command", b"command", "op_type", b"op_type", "root", b"root"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["command", b"command", "op_type", b"op_type", "root", b"root"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["op_type", b"op_type"]) -> typing_extensions.Literal["root", "command"] | None: ...
...
class UserContext(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["extensions", b"extensions", "user_id", b"user_id", "user_name", b"user_name"]) -> None: ...
...
class AnalyzePlanRequest(google.protobuf.message.Message):
    ...
    class Explain(google.protobuf.message.Message):
        ...
        class _ExplainModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[AnalyzePlanRequest.Explain._ExplainMode.ValueType], builtins.type):  # noqa: F821
        ...
        def HasField(self, field_name: typing_extensions.Literal["plan", b"plan"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["explain_mode", b"explain_mode", "plan", b"plan"]) -> None: ...
    ...
    class TreeString(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_level", b"_level", "level", b"level", "plan", b"plan"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_level", b"_level", "level", b"level", "plan", b"plan"]) -> None: ...
    ...
    class DDLParse(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["ddl_string", b"ddl_string"]) -> None: ...
    ...
    class SameSemantics(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["other_plan", b"other_plan", "target_plan", b"target_plan"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["other_plan", b"other_plan", "target_plan", b"target_plan"]) -> None: ...
    ...
    class Persist(google.protobuf.message.Message):
        ...
        @property
        def relation(self) -> spark.connect.relations_pb2.Relation:
            """(Required) The logical plan to persist."""
        @property
        def storage_level(self) -> spark.connect.common_pb2.StorageLevel:
            """(Optional) The storage level."""
        def __init__(
            self,
            *,
            relation: spark.connect.relations_pb2.Relation | None = ...,
            storage_level: spark.connect.common_pb2.StorageLevel | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["_storage_level", b"_storage_level", "relation", b"relation", "storage_level", b"storage_level"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_storage_level", b"_storage_level", "relation", b"relation", "storage_level", b"storage_level"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_storage_level", b"_storage_level"]) -> typing_extensions.Literal["storage_level"] | None: ...
    ...
    class Unpersist(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_blocking", b"_blocking", "blocking", b"blocking", "relation", b"relation"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_blocking", b"_blocking", "blocking", b"blocking", "relation", b"relation"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_blocking", b"_blocking"]) -> typing_extensions.Literal["blocking"] | None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "analyze", b"analyze", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "ddl_parse", b"ddl_parse", "explain", b"explain", "get_storage_level", b"get_storage_level", "input_files", b"input_files", "is_local", b"is_local", "is_streaming", b"is_streaming", "persist", b"persist", "same_semantics", b"same_semantics", "schema", b"schema", "semantic_hash", b"semantic_hash", "spark_version", b"spark_version", "tree_string", b"tree_string", "unpersist", b"unpersist", "user_context", b"user_context"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "analyze", b"analyze", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "ddl_parse", b"ddl_parse", "explain", b"explain", "get_storage_level", b"get_storage_level", "input_files", b"input_files", "is_local", b"is_local", "is_streaming", b"is_streaming", "persist", b"persist", "same_semantics", b"same_semantics", "schema", b"schema", "semantic_hash", b"semantic_hash", "session_id", b"session_id", "spark_version", b"spark_version", "tree_string", b"tree_string", "unpersist", b"unpersist", "user_context", b"user_context"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id"]) -> typing_extensions.Literal["client_observed_server_side_session_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_type", b"_client_type"]) -> typing_extensions.Literal["client_type"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["analyze", b"analyze"]) -> typing_extensions.Literal["schema", "explain", "tree_string", "is_local", "is_streaming", "input_files", "spark_version", "ddl_parse", "same_semantics", "semantic_hash", "persist", "unpersist", "get_storage_level"] | None: ...
...
class AnalyzePlanResponse(google.protobuf.message.Message):
    ...
    class Explain(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["explain_string", b"explain_string"]) -> None: ...
    ...
    class TreeString(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["tree_string", b"tree_string"]) -> None: ...
    ...
    class IsLocal(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["is_local", b"is_local"]) -> None: ...
    ...
    class IsStreaming(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["is_streaming", b"is_streaming"]) -> None: ...
    ...
    class DDLParse(google.protobuf.message.Message):
        ...
        @property
        def parsed(self) -> spark.connect.types_pb2.DataType: ...
        def __init__(
            self,
            *,
            parsed: spark.connect.types_pb2.DataType | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["parsed", b"parsed"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["parsed", b"parsed"]) -> None: ...
    ...
    class GetStorageLevel(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["storage_level", b"storage_level"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["storage_level", b"storage_level"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["ddl_parse", b"ddl_parse", "explain", b"explain", "get_storage_level", b"get_storage_level", "input_files", b"input_files", "is_local", b"is_local", "is_streaming", b"is_streaming", "persist", b"persist", "result", b"result", "same_semantics", b"same_semantics", "schema", b"schema", "semantic_hash", b"semantic_hash", "spark_version", b"spark_version", "tree_string", b"tree_string", "unpersist", b"unpersist"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ddl_parse", b"ddl_parse", "explain", b"explain", "get_storage_level", b"get_storage_level", "input_files", b"input_files", "is_local", b"is_local", "is_streaming", b"is_streaming", "persist", b"persist", "result", b"result", "same_semantics", b"same_semantics", "schema", b"schema", "semantic_hash", b"semantic_hash", "server_side_session_id", b"server_side_session_id", "session_id", b"session_id", "spark_version", b"spark_version", "tree_string", b"tree_string", "unpersist", b"unpersist"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["result", b"result"]) -> typing_extensions.Literal["schema", "explain", "tree_string", "is_local", "is_streaming", "input_files", "spark_version", "ddl_parse", "same_semantics", "semantic_hash", "persist", "unpersist", "get_storage_level"] | None: ...
...
class ExecutePlanRequest(google.protobuf.message.Message):
    ...
    class RequestOption(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["extension", b"extension", "reattach_options", b"reattach_options", "request_option", b"request_option"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["extension", b"extension", "reattach_options", b"reattach_options", "request_option", b"request_option"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["request_option", b"request_option"]) -> typing_extensions.Literal["reattach_options", "extension"] | None: ...
    ...
    """
    @property
    def request_options(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ExecutePlanRequest.RequestOption]:
    ...
    def __init__(
        ...
        *,
        ...
        plan: global___Plan | None = ...,
        client_type: builtins.str | None = ...,
        request_options: collections.abc.Iterable[global___ExecutePlanRequest.RequestOption] | None = ...,
        tags: collections.abc.Iterable[builtins.str] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "_operation_id", b"_operation_id", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "operation_id", b"operation_id", "plan", b"plan", "user_context", b"user_context"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "_operation_id", b"_operation_id", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "operation_id", b"operation_id", "plan", b"plan", "request_options", b"request_options", "session_id", b"session_id", "tags", b"tags", "user_context", b"user_context"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id"]) -> typing_extensions.Literal["client_observed_server_side_session_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_type", b"_client_type"]) -> typing_extensions.Literal["client_type"] | None: ...
...
class ExecutePlanResponse(google.protobuf.message.Message):
    ...
    class ArrowBatch(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_start_offset", b"_start_offset", "start_offset", b"start_offset"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_start_offset", b"_start_offset", "data", b"data", "row_count", b"row_count", "start_offset", b"start_offset"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_start_offset", b"_start_offset"]) -> typing_extensions.Literal["start_offset"] | None: ...
    ...
    class Metrics(google.protobuf.message.Message):
        ...
        class MetricObject(google.protobuf.message.Message):
            ...
            def __init__(
                ...
                *,
                ...
                plan_id: builtins.int = ...,
                parent: builtins.int = ...,
                execution_metrics: collections.abc.Mapping[builtins.str, global___ExecutePlanResponse.Metrics.MetricValue] | None = ...,
            ) -> None: ...
            def ClearField(self, field_name: typing_extensions.Literal["execution_metrics", b"execution_metrics", "name", b"name", "parent", b"parent", "plan_id", b"plan_id"]) -> None: ...
        ...
        class MetricValue(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing_extensions.Literal["metric_type", b"metric_type", "name", b"name", "value", b"value"]) -> None: ...
        ...
        def __init__(
            self,
            *,
            metrics: collections.abc.Iterable[global___ExecutePlanResponse.Metrics.MetricObject] | None = ...,
        ) -> None: ...
    ...
    class ObservedMetrics(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["keys", b"keys", "name", b"name", "plan_id", b"plan_id", "values", b"values"]) -> None: ...
    ...
    class ExecutionProgress(google.protobuf.message.Message):
        ...
        class StageInfo(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing_extensions.Literal["done", b"done", "input_bytes_read", b"input_bytes_read", "num_completed_tasks", b"num_completed_tasks", "num_tasks", b"num_tasks", "stage_id", b"stage_id"]) -> None: ...

        STAGES_FIELD_NUMBER: builtins.int
        NUM_INFLIGHT_TASKS_FIELD_NUMBER: builtins.int
        @property
        def stages(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ExecutePlanResponse.ExecutionProgress.StageInfo]:
        ...
        def __init__(
            self,
            *,
            stages: collections.abc.Iterable[global___ExecutePlanResponse.ExecutionProgress.StageInfo] | None = ...,
            num_inflight_tasks: builtins.int = ...,
        ) -> None: ...
        def ClearField(self, field_name: typing_extensions.Literal["num_inflight_tasks", b"num_inflight_tasks", "stages", b"stages"]) -> None: ...
    ...
    @property
    def write_stream_operation_start_result(self) -> spark.connect.commands_pb2.WriteStreamOperationStartResult:
        """Response for a streaming query."""
    @property
    def streaming_query_command_result(self) -> spark.connect.commands_pb2.StreamingQueryCommandResult:
        """Response for commands on a streaming query."""
    @property
    def get_resources_command_result(self) -> spark.connect.commands_pb2.GetResourcesCommandResult:
        """Response for 'SparkContext.resources'."""
    @property
    def streaming_query_manager_command_result(self) -> spark.connect.commands_pb2.StreamingQueryManagerCommandResult:
        """Response for commands on the streaming query manager."""
    @property
    def streaming_query_listener_events_result(self) -> spark.connect.commands_pb2.StreamingQueryListenerEventsResult:
    ...
    @property
    def create_resource_profile_command_result(self) -> spark.connect.commands_pb2.CreateResourceProfileCommandResult:
    ...
    def __init__(
        ...
        *,
        ...
        write_stream_operation_start_result: spark.connect.commands_pb2.WriteStreamOperationStartResult | None = ...,
        streaming_query_command_result: spark.connect.commands_pb2.StreamingQueryCommandResult | None = ...,
        get_resources_command_result: spark.connect.commands_pb2.GetResourcesCommandResult | None = ...,
        streaming_query_manager_command_result: spark.connect.commands_pb2.StreamingQueryManagerCommandResult | None = ...,
        streaming_query_listener_events_result: spark.connect.commands_pb2.StreamingQueryListenerEventsResult | None = ...,
        result_complete: global___ExecutePlanResponse.ResultComplete | None = ...,
        create_resource_profile_command_result: spark.connect.commands_pb2.CreateResourceProfileCommandResult | None = ...,
        ...
        observed_metrics: collections.abc.Iterable[global___ExecutePlanResponse.ObservedMetrics] | None = ...,
        schema: spark.connect.types_pb2.DataType | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["arrow_batch", b"arrow_batch", "checkpoint_command_result", b"checkpoint_command_result", "create_resource_profile_command_result", b"create_resource_profile_command_result", "execution_progress", b"execution_progress", "extension", b"extension", "get_resources_command_result", b"get_resources_command_result", "metrics", b"metrics", "response_type", b"response_type", "result_complete", b"result_complete", "schema", b"schema", "sql_command_result", b"sql_command_result", "streaming_query_command_result", b"streaming_query_command_result", "streaming_query_listener_events_result", b"streaming_query_listener_events_result", "streaming_query_manager_command_result", b"streaming_query_manager_command_result", "write_stream_operation_start_result", b"write_stream_operation_start_result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["arrow_batch", b"arrow_batch", "checkpoint_command_result", b"checkpoint_command_result", "create_resource_profile_command_result", b"create_resource_profile_command_result", "execution_progress", b"execution_progress", "extension", b"extension", "get_resources_command_result", b"get_resources_command_result", "metrics", b"metrics", "observed_metrics", b"observed_metrics", "operation_id", b"operation_id", "response_id", b"response_id", "response_type", b"response_type", "result_complete", b"result_complete", "schema", b"schema", "server_side_session_id", b"server_side_session_id", "session_id", b"session_id", "sql_command_result", b"sql_command_result", "streaming_query_command_result", b"streaming_query_command_result", "streaming_query_listener_events_result", b"streaming_query_listener_events_result", "streaming_query_manager_command_result", b"streaming_query_manager_command_result", "write_stream_operation_start_result", b"write_stream_operation_start_result"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["response_type", b"response_type"]) -> typing_extensions.Literal["arrow_batch", "sql_command_result", "write_stream_operation_start_result", "streaming_query_command_result", "get_resources_command_result", "streaming_query_manager_command_result", "streaming_query_listener_events_result", "result_complete", "create_resource_profile_command_result", "execution_progress", "checkpoint_command_result", "extension"] | None: ...
...
class ConfigRequest(google.protobuf.message.Message):
    ...
    class Operation(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["get", b"get", "get_all", b"get_all", "get_option", b"get_option", "get_with_default", b"get_with_default", "is_modifiable", b"is_modifiable", "op_type", b"op_type", "set", b"set", "unset", b"unset"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["get", b"get", "get_all", b"get_all", "get_option", b"get_option", "get_with_default", b"get_with_default", "is_modifiable", b"is_modifiable", "op_type", b"op_type", "set", b"set", "unset", b"unset"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["op_type", b"op_type"]) -> typing_extensions.Literal["set", "get", "get_with_default", "get_option", "get_all", "unset", "is_modifiable"] | None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "operation", b"operation", "user_context", b"user_context"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "operation", b"operation", "session_id", b"session_id", "user_context", b"user_context"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id"]) -> typing_extensions.Literal["client_observed_server_side_session_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_type", b"_client_type"]) -> typing_extensions.Literal["client_type"] | None: ...
...
class ConfigResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["pairs", b"pairs", "server_side_session_id", b"server_side_session_id", "session_id", b"session_id", "warnings", b"warnings"]) -> None: ...
...
class AddArtifactsRequest(google.protobuf.message.Message):
    ...
    class ArtifactChunk(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["crc", b"crc", "data", b"data"]) -> None: ...
    ...
    class Batch(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            artifacts: collections.abc.Iterable[global___AddArtifactsRequest.SingleChunkArtifact] | None = ...,
        ) -> None: ...
    ...
    class BeginChunkedArtifact(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["initial_chunk", b"initial_chunk"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["initial_chunk", b"initial_chunk", "name", b"name", "num_chunks", b"num_chunks", "total_bytes", b"total_bytes"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "batch", b"batch", "begin_chunk", b"begin_chunk", "chunk", b"chunk", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "payload", b"payload", "user_context", b"user_context"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "batch", b"batch", "begin_chunk", b"begin_chunk", "chunk", b"chunk", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "payload", b"payload", "session_id", b"session_id", "user_context", b"user_context"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id"]) -> typing_extensions.Literal["client_observed_server_side_session_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_type", b"_client_type"]) -> typing_extensions.Literal["client_type"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["payload", b"payload"]) -> typing_extensions.Literal["batch", "begin_chunk", "chunk"] | None: ...
...
class AddArtifactsResponse(google.protobuf.message.Message):
    ...
    class ArtifactSummary(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["is_crc_successful", b"is_crc_successful", "name", b"name"]) -> None: ...
    ...
    def __init__(
        ...
        *,
        session_id: builtins.str = ...,
        server_side_session_id: builtins.str = ...,
        artifacts: collections.abc.Iterable[global___AddArtifactsResponse.ArtifactSummary] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["artifacts", b"artifacts", "server_side_session_id", b"server_side_session_id", "session_id", b"session_id"]) -> None: ...
...
class ArtifactStatusesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "user_context", b"user_context"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "names", b"names", "session_id", b"session_id", "user_context", b"user_context"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id"]) -> typing_extensions.Literal["client_observed_server_side_session_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_type", b"_client_type"]) -> typing_extensions.Literal["client_type"] | None: ...
...
class ArtifactStatusesResponse(google.protobuf.message.Message):
    ...
    """
    @property
    def statuses(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___ArtifactStatusesResponse.ArtifactStatus]:
    ...
    def __init__(
        ...
        *,
        session_id: builtins.str = ...,
        server_side_session_id: builtins.str = ...,
        statuses: collections.abc.Mapping[builtins.str, global___ArtifactStatusesResponse.ArtifactStatus] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["server_side_session_id", b"server_side_session_id", "session_id", b"session_id", "statuses", b"statuses"]) -> None: ...
...
class InterruptRequest(google.protobuf.message.Message):
    ...
    class _InterruptTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[InterruptRequest._InterruptType.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def HasField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "interrupt", b"interrupt", "operation_id", b"operation_id", "operation_tag", b"operation_tag", "user_context", b"user_context"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "interrupt", b"interrupt", "interrupt_type", b"interrupt_type", "operation_id", b"operation_id", "operation_tag", b"operation_tag", "session_id", b"session_id", "user_context", b"user_context"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id"]) -> typing_extensions.Literal["client_observed_server_side_session_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_type", b"_client_type"]) -> typing_extensions.Literal["client_type"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["interrupt", b"interrupt"]) -> typing_extensions.Literal["operation_tag", "operation_id"] | None: ...
...
class InterruptResponse(google.protobuf.message.Message):
    ...
    """
    @property
    def interrupted_ids(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
    ...
    def ClearField(self, field_name: typing_extensions.Literal["interrupted_ids", b"interrupted_ids", "server_side_session_id", b"server_side_session_id", "session_id", b"session_id"]) -> None: ...
...
class ReattachOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["reattachable", b"reattachable"]) -> None: ...
...
class ReattachExecuteRequest(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_type", b"_client_type"]) -> typing_extensions.Literal["client_type"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_last_response_id", b"_last_response_id"]) -> typing_extensions.Literal["last_response_id"] | None: ...
...
class ReleaseExecuteRequest(google.protobuf.message.Message):
    ...
    class ReleaseUntil(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["response_id", b"response_id"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "release", b"release", "release_all", b"release_all", "release_until", b"release_until", "user_context", b"user_context"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "operation_id", b"operation_id", "release", b"release", "release_all", b"release_all", "release_until", b"release_until", "session_id", b"session_id", "user_context", b"user_context"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id"]) -> typing_extensions.Literal["client_observed_server_side_session_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_type", b"_client_type"]) -> typing_extensions.Literal["client_type"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["release", b"release"]) -> typing_extensions.Literal["release_all", "release_until"] | None: ...
...
class ReleaseExecuteResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_operation_id", b"_operation_id", "operation_id", b"operation_id", "server_side_session_id", b"server_side_session_id", "session_id", b"session_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_operation_id", b"_operation_id"]) -> typing_extensions.Literal["operation_id"] | None: ...
...
class ReleaseSessionRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_client_type", b"_client_type", "client_type", b"client_type", "user_context", b"user_context"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_client_type", b"_client_type", "client_type", b"client_type", "session_id", b"session_id", "user_context", b"user_context"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_type", b"_client_type"]) -> typing_extensions.Literal["client_type"] | None: ...
...
class ReleaseSessionResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["server_side_session_id", b"server_side_session_id", "session_id", b"session_id"]) -> None: ...
...
class FetchErrorDetailsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "user_context", b"user_context"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id", "_client_type", b"_client_type", "client_observed_server_side_session_id", b"client_observed_server_side_session_id", "client_type", b"client_type", "error_id", b"error_id", "session_id", b"session_id", "user_context", b"user_context"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_observed_server_side_session_id", b"_client_observed_server_side_session_id"]) -> typing_extensions.Literal["client_observed_server_side_session_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_client_type", b"_client_type"]) -> typing_extensions.Literal["client_type"] | None: ...
...
class FetchErrorDetailsResponse(google.protobuf.message.Message):
    ...
    class StackTraceElement(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_file_name", b"_file_name", "file_name", b"file_name"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_file_name", b"_file_name", "declaring_class", b"declaring_class", "file_name", b"file_name", "line_number", b"line_number", "method_name", b"method_name"]) -> None: ...
    ...
    class QueryContext(google.protobuf.message.Message):
        ...
        class _ContextTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[FetchErrorDetailsResponse.QueryContext._ContextType.ValueType], builtins.type):  # noqa: F821
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        ...
        def ClearField(self, field_name: typing_extensions.Literal["call_site", b"call_site", "context_type", b"context_type", "fragment", b"fragment", "object_name", b"object_name", "object_type", b"object_type", "start_index", b"start_index", "stop_index", b"stop_index", "summary", b"summary"]) -> None: ...
    ...
    class SparkThrowable(google.protobuf.message.Message):
        ...
        @property
        def message_parameters(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, builtins.str]:
            """The message parameters for the error framework."""
        @property
        def query_contexts(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FetchErrorDetailsResponse.QueryContext]:
        ...
        def __init__(
            ...
            *,
            ...
            query_contexts: collections.abc.Iterable[global___FetchErrorDetailsResponse.QueryContext] | None = ...,
            sql_state: builtins.str | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["_error_class", b"_error_class", "_sql_state", b"_sql_state", "error_class", b"error_class", "sql_state", b"sql_state"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_error_class", b"_error_class", "_sql_state", b"_sql_state", "error_class", b"error_class", "message_parameters", b"message_parameters", "query_contexts", b"query_contexts", "sql_state", b"sql_state"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_error_class", b"_error_class"]) -> typing_extensions.Literal["error_class"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_sql_state", b"_sql_state"]) -> typing_extensions.Literal["sql_state"] | None: ...
    ...
    class Error(google.protobuf.message.Message):
        ...
        @property
        def error_type_hierarchy(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
            """The fully qualified names of the exception class and its parent classes."""
        message: builtins.str
        """The detailed message of the exception."""
        @property
        def stack_trace(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FetchErrorDetailsResponse.StackTraceElement]:
        ...
        def __init__(
            ...
            *,
            ...
            message: builtins.str = ...,
            stack_trace: collections.abc.Iterable[global___FetchErrorDetailsResponse.StackTraceElement] | None = ...,
            cause_idx: builtins.int | None = ...,
            spark_throwable: global___FetchErrorDetailsResponse.SparkThrowable | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["_cause_idx", b"_cause_idx", "_spark_throwable", b"_spark_throwable", "cause_idx", b"cause_idx", "spark_throwable", b"spark_throwable"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_cause_idx", b"_cause_idx", "_spark_throwable", b"_spark_throwable", "cause_idx", b"cause_idx", "error_type_hierarchy", b"error_type_hierarchy", "message", b"message", "spark_throwable", b"spark_throwable", "stack_trace", b"stack_trace"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_cause_idx", b"_cause_idx"]) -> typing_extensions.Literal["cause_idx"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_spark_throwable", b"_spark_throwable"]) -> typing_extensions.Literal["spark_throwable"] | None: ...
    ...
    @property
    def errors(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FetchErrorDetailsResponse.Error]:
        """A list of errors."""
    def __init__(
        self,
        *,
    ...
    def HasField(self, field_name: typing_extensions.Literal["_root_error_idx", b"_root_error_idx", "root_error_idx", b"root_error_idx"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_root_error_idx", b"_root_error_idx", "errors", b"errors", "root_error_idx", b"root_error_idx", "server_side_session_id", b"server_side_session_id", "session_id", b"session_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_root_error_idx", b"_root_error_idx"]) -> typing_extensions.Literal["root_error_idx"] | None: ...
...
class CheckpointCommandResult(google.protobuf.message.Message):
    ...
    RELATION_FIELD_NUMBER: builtins.int
    @property
    def relation(self) -> spark.connect.relations_pb2.CachedRemoteRelation:
        """(Required) The logical plan checkpointed."""
    def __init__(
        self,
        *,
        relation: spark.connect.relations_pb2.CachedRemoteRelation | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["relation", b"relation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["relation", b"relation"]) -> None: ...
