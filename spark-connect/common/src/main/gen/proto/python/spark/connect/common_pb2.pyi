...
class StorageLevel(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deserialized", b"deserialized", "replication", b"replication", "use_disk", b"use_disk", "use_memory", b"use_memory", "use_off_heap", b"use_off_heap"]) -> None: ...
...
class ResourceInformation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["addresses", b"addresses", "name", b"name"]) -> None: ...
...
class ExecutorResourceRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_discovery_script", b"_discovery_script", "_vendor", b"_vendor", "discovery_script", b"discovery_script", "vendor", b"vendor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_discovery_script", b"_discovery_script", "_vendor", b"_vendor", "amount", b"amount", "discovery_script", b"discovery_script", "resource_name", b"resource_name", "vendor", b"vendor"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_discovery_script", b"_discovery_script"]) -> typing_extensions.Literal["discovery_script"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_vendor", b"_vendor"]) -> typing_extensions.Literal["vendor"] | None: ...
...
class TaskResourceRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["amount", b"amount", "resource_name", b"resource_name"]) -> None: ...
...
class ResourceProfile(google.protobuf.message.Message):
    ...
    @property
    def executor_resources(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___ExecutorResourceRequest]:
        """(Optional) Resource requests for executors. Mapped from the resource name
        (e.g., cores, memory, CPU) to its specific request.
        """
    @property
    def task_resources(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___TaskResourceRequest]:
    ...
    def __init__(
        self,
        *,
        executor_resources: collections.abc.Mapping[builtins.str, global___ExecutorResourceRequest] | None = ...,
        task_resources: collections.abc.Mapping[builtins.str, global___TaskResourceRequest] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["executor_resources", b"executor_resources", "task_resources", b"task_resources"]) -> None: ...
