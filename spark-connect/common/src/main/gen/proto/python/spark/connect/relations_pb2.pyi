...
import spark.connect.catalog_pb2
import spark.connect.expressions_pb2
import spark.connect.types_pb2
import sys
import typing
...
class Relation(google.protobuf.message.Message):
    ...
    @property
    def common_inline_user_defined_table_function(self) -> global___CommonInlineUserDefinedTableFunction: ...
    @property
    def as_of_join(self) -> global___AsOfJoin: ...
    @property
    def common_inline_user_defined_data_source(self) -> global___CommonInlineUserDefinedDataSource: ...
    @property
    ...
    @property
    def catalog(self) -> spark.connect.catalog_pb2.Catalog:
    ...
    def __init__(
        ...
        *,
        ...
        common_inline_user_defined_table_function: global___CommonInlineUserDefinedTableFunction | None = ...,
        as_of_join: global___AsOfJoin | None = ...,
        common_inline_user_defined_data_source: global___CommonInlineUserDefinedDataSource | None = ...,
        ...
        catalog: spark.connect.catalog_pb2.Catalog | None = ...,
        extension: google.protobuf.any_pb2.Any | None = ...,
        unknown: global___Unknown | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["aggregate", b"aggregate", "apply_in_pandas_with_state", b"apply_in_pandas_with_state", "approx_quantile", b"approx_quantile", "as_of_join", b"as_of_join", "cached_local_relation", b"cached_local_relation", "cached_remote_relation", b"cached_remote_relation", "catalog", b"catalog", "co_group_map", b"co_group_map", "collect_metrics", b"collect_metrics", "common", b"common", "common_inline_user_defined_data_source", b"common_inline_user_defined_data_source", "common_inline_user_defined_table_function", b"common_inline_user_defined_table_function", "corr", b"corr", "cov", b"cov", "crosstab", b"crosstab", "deduplicate", b"deduplicate", "describe", b"describe", "drop", b"drop", "drop_na", b"drop_na", "extension", b"extension", "fill_na", b"fill_na", "filter", b"filter", "freq_items", b"freq_items", "group_map", b"group_map", "hint", b"hint", "html_string", b"html_string", "join", b"join", "limit", b"limit", "local_relation", b"local_relation", "map_partitions", b"map_partitions", "offset", b"offset", "parse", b"parse", "project", b"project", "range", b"range", "read", b"read", "rel_type", b"rel_type", "repartition", b"repartition", "repartition_by_expression", b"repartition_by_expression", "replace", b"replace", "sample", b"sample", "sample_by", b"sample_by", "set_op", b"set_op", "show_string", b"show_string", "sort", b"sort", "sql", b"sql", "subquery_alias", b"subquery_alias", "summary", b"summary", "tail", b"tail", "to_df", b"to_df", "to_schema", b"to_schema", "unknown", b"unknown", "unpivot", b"unpivot", "with_columns", b"with_columns", "with_columns_renamed", b"with_columns_renamed", "with_relations", b"with_relations", "with_watermark", b"with_watermark"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["aggregate", b"aggregate", "apply_in_pandas_with_state", b"apply_in_pandas_with_state", "approx_quantile", b"approx_quantile", "as_of_join", b"as_of_join", "cached_local_relation", b"cached_local_relation", "cached_remote_relation", b"cached_remote_relation", "catalog", b"catalog", "co_group_map", b"co_group_map", "collect_metrics", b"collect_metrics", "common", b"common", "common_inline_user_defined_data_source", b"common_inline_user_defined_data_source", "common_inline_user_defined_table_function", b"common_inline_user_defined_table_function", "corr", b"corr", "cov", b"cov", "crosstab", b"crosstab", "deduplicate", b"deduplicate", "describe", b"describe", "drop", b"drop", "drop_na", b"drop_na", "extension", b"extension", "fill_na", b"fill_na", "filter", b"filter", "freq_items", b"freq_items", "group_map", b"group_map", "hint", b"hint", "html_string", b"html_string", "join", b"join", "limit", b"limit", "local_relation", b"local_relation", "map_partitions", b"map_partitions", "offset", b"offset", "parse", b"parse", "project", b"project", "range", b"range", "read", b"read", "rel_type", b"rel_type", "repartition", b"repartition", "repartition_by_expression", b"repartition_by_expression", "replace", b"replace", "sample", b"sample", "sample_by", b"sample_by", "set_op", b"set_op", "show_string", b"show_string", "sort", b"sort", "sql", b"sql", "subquery_alias", b"subquery_alias", "summary", b"summary", "tail", b"tail", "to_df", b"to_df", "to_schema", b"to_schema", "unknown", b"unknown", "unpivot", b"unpivot", "with_columns", b"with_columns", "with_columns_renamed", b"with_columns_renamed", "with_relations", b"with_relations", "with_watermark", b"with_watermark"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["rel_type", b"rel_type"]) -> typing_extensions.Literal["read", "project", "filter", "join", "set_op", "sort", "limit", "aggregate", "sql", "local_relation", "sample", "offset", "deduplicate", "range", "subquery_alias", "repartition", "to_df", "with_columns_renamed", "show_string", "drop", "tail", "with_columns", "hint", "unpivot", "to_schema", "repartition_by_expression", "map_partitions", "collect_metrics", "parse", "group_map", "co_group_map", "with_watermark", "apply_in_pandas_with_state", "html_string", "cached_local_relation", "cached_remote_relation", "common_inline_user_defined_table_function", "as_of_join", "common_inline_user_defined_data_source", "with_relations", "fill_na", "drop_na", "replace", "summary", "crosstab", "describe", "cov", "corr", "approx_quantile", "freq_items", "sample_by", "catalog", "extension", "unknown"] | None: ...
...
class RelationCommon(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_plan_id", b"_plan_id", "plan_id", b"plan_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_plan_id", b"_plan_id", "plan_id", b"plan_id", "source_info", b"source_info"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_plan_id", b"_plan_id"]) -> typing_extensions.Literal["plan_id"] | None: ...
...
class SQL(google.protobuf.message.Message):
    ...
    class ArgsEntry(google.protobuf.message.Message):
        ...
        key: builtins.str
        @property
        def value(self) -> spark.connect.expressions_pb2.Expression.Literal: ...
        def __init__(
            self,
            *,
            key: builtins.str = ...,
            value: spark.connect.expressions_pb2.Expression.Literal | None = ...,
        ) -> None: ...
    ...
    class NamedArgumentsEntry(google.protobuf.message.Message):
        ...
        key: builtins.str
        @property
        def value(self) -> spark.connect.expressions_pb2.Expression: ...
        def __init__(
            self,
            *,
            key: builtins.str = ...,
            value: spark.connect.expressions_pb2.Expression | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value", b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key", b"key", "value", b"value"]) -> None: ...
    ...
    @property
    def args(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, spark.connect.expressions_pb2.Expression.Literal]:
        """(Optional) A map of parameter names to literal expressions."""
    @property
    def pos_args(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression.Literal]:
        """(Optional) A sequence of literal expressions for positional parameters in the SQL query text."""
    @property
    def named_arguments(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, spark.connect.expressions_pb2.Expression]:
        """(Optional) A map of parameter names to expressions.
        It cannot coexist with `pos_arguments`.
        """
    @property
    def pos_arguments(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
    ...
    def __init__(
        ...
        *,
        query: builtins.str = ...,
        args: collections.abc.Mapping[builtins.str, spark.connect.expressions_pb2.Expression.Literal] | None = ...,
        pos_args: collections.abc.Iterable[spark.connect.expressions_pb2.Expression.Literal] | None = ...,
        named_arguments: collections.abc.Mapping[builtins.str, spark.connect.expressions_pb2.Expression] | None = ...,
        pos_arguments: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["args", b"args", "named_arguments", b"named_arguments", "pos_args", b"pos_args", "pos_arguments", b"pos_arguments", "query", b"query"]) -> None: ...
...
class WithRelations(google.protobuf.message.Message):
    ...
    def root(self) -> global___Relation:
        ...
        """
    @property
    def references(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Relation]:
    ...
    def ClearField(self, field_name: typing_extensions.Literal["references", b"references", "root", b"root"]) -> None: ...
...
class Read(google.protobuf.message.Message):
    ...
    class NamedTable(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["options", b"options", "unparsed_identifier", b"unparsed_identifier"]) -> None: ...
    ...
    class DataSource(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_format", b"_format", "_schema", b"_schema", "format", b"format", "schema", b"schema"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_format", b"_format", "_schema", b"_schema", "format", b"format", "options", b"options", "paths", b"paths", "predicates", b"predicates", "schema", b"schema"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_format", b"_format"]) -> typing_extensions.Literal["format"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_schema", b"_schema"]) -> typing_extensions.Literal["schema"] | None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["data_source", b"data_source", "named_table", b"named_table", "read_type", b"read_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data_source", b"data_source", "is_streaming", b"is_streaming", "named_table", b"named_table", "read_type", b"read_type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["read_type", b"read_type"]) -> typing_extensions.Literal["named_table", "data_source"] | None: ...
...
class Project(google.protobuf.message.Message):
    ...
    def input(self) -> global___Relation:
        ...
        """
    @property
    def expressions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
        """(Required) A Project requires at least one expression."""
    def __init__(
        self,
        *,
        input: global___Relation | None = ...,
        expressions: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["expressions", b"expressions", "input", b"input"]) -> None: ...
...
class Filter(google.protobuf.message.Message):
    ...
    @property
    def condition(self) -> spark.connect.expressions_pb2.Expression:
        """(Required) A Filter must have a condition expression."""
    def __init__(
        self,
        *,
        input: global___Relation | None = ...,
        condition: spark.connect.expressions_pb2.Expression | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["condition", b"condition", "input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["condition", b"condition", "input", b"input"]) -> None: ...
...
class Join(google.protobuf.message.Message):
    ...
    class _JoinTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Join._JoinType.ValueType], builtins.type):  # noqa: F821
    ...
    class JoinDataType(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["is_left_struct", b"is_left_struct", "is_right_struct", b"is_right_struct"]) -> None: ...
    ...
    @property
    def join_condition(self) -> spark.connect.expressions_pb2.Expression:
    ...
    def __init__(
        ...
        *,
        ...
        join_condition: spark.connect.expressions_pb2.Expression | None = ...,
        join_type: global___Join.JoinType.ValueType = ...,
        using_columns: collections.abc.Iterable[builtins.str] | None = ...,
        join_data_type: global___Join.JoinDataType | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_join_data_type", b"_join_data_type", "join_condition", b"join_condition", "join_data_type", b"join_data_type", "left", b"left", "right", b"right"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_join_data_type", b"_join_data_type", "join_condition", b"join_condition", "join_data_type", b"join_data_type", "join_type", b"join_type", "left", b"left", "right", b"right", "using_columns", b"using_columns"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_join_data_type", b"_join_data_type"]) -> typing_extensions.Literal["join_data_type"] | None: ...
...
class SetOperation(google.protobuf.message.Message):
    ...
    class _SetOpTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[SetOperation._SetOpType.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def HasField(self, field_name: typing_extensions.Literal["_allow_missing_columns", b"_allow_missing_columns", "_by_name", b"_by_name", "_is_all", b"_is_all", "allow_missing_columns", b"allow_missing_columns", "by_name", b"by_name", "is_all", b"is_all", "left_input", b"left_input", "right_input", b"right_input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_allow_missing_columns", b"_allow_missing_columns", "_by_name", b"_by_name", "_is_all", b"_is_all", "allow_missing_columns", b"allow_missing_columns", "by_name", b"by_name", "is_all", b"is_all", "left_input", b"left_input", "right_input", b"right_input", "set_op_type", b"set_op_type"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_allow_missing_columns", b"_allow_missing_columns"]) -> typing_extensions.Literal["allow_missing_columns"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_by_name", b"_by_name"]) -> typing_extensions.Literal["by_name"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_is_all", b"_is_all"]) -> typing_extensions.Literal["is_all"] | None: ...
...
class Limit(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["input", b"input", "limit", b"limit"]) -> None: ...
...
class Offset(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["input", b"input", "offset", b"offset"]) -> None: ...
...
class Aggregate(google.protobuf.message.Message):
    ...
    class _GroupTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Aggregate._GroupType.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class Pivot(google.protobuf.message.Message):
        ...
        @property
        def col(self) -> spark.connect.expressions_pb2.Expression:
            """(Required) The column to pivot"""
        @property
        def values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression.Literal]:
        ...
        def __init__(
            self,
            *,
            col: spark.connect.expressions_pb2.Expression | None = ...,
            values: collections.abc.Iterable[spark.connect.expressions_pb2.Expression.Literal] | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["col", b"col"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["col", b"col", "values", b"values"]) -> None: ...
    ...
    class GroupingSets(google.protobuf.message.Message):
        ...
        @property
        def grouping_set(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
            """(Required) Individual grouping set"""
        def __init__(
            self,
            *,
            grouping_set: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        ) -> None: ...
        def ClearField(self, field_name: typing_extensions.Literal["grouping_set", b"grouping_set"]) -> None: ...
    ...
    @property
    def grouping_expressions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
        """(Required) Expressions for grouping keys"""
    @property
    def aggregate_expressions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
    ...
    @property
    def grouping_sets(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Aggregate.GroupingSets]:
        """(Optional) List of values that will be translated to columns in the output DataFrame."""
    def __init__(
        self,
        *,
        input: global___Relation | None = ...,
        group_type: global___Aggregate.GroupType.ValueType = ...,
        grouping_expressions: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        aggregate_expressions: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        pivot: global___Aggregate.Pivot | None = ...,
        grouping_sets: collections.abc.Iterable[global___Aggregate.GroupingSets] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input", "pivot", b"pivot"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["aggregate_expressions", b"aggregate_expressions", "group_type", b"group_type", "grouping_expressions", b"grouping_expressions", "grouping_sets", b"grouping_sets", "input", b"input", "pivot", b"pivot"]) -> None: ...
...
class Sort(google.protobuf.message.Message):
    ...
    @property
    def order(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression.SortOrder]:
    ...
    def __init__(
        ...
        *,
        input: global___Relation | None = ...,
        order: collections.abc.Iterable[spark.connect.expressions_pb2.Expression.SortOrder] | None = ...,
        is_global: builtins.bool | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_is_global", b"_is_global", "input", b"input", "is_global", b"is_global"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_is_global", b"_is_global", "input", b"input", "is_global", b"is_global", "order", b"order"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_is_global", b"_is_global"]) -> typing_extensions.Literal["is_global"] | None: ...
...
class Drop(google.protobuf.message.Message):
    ...
    @property
    def columns(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
    ...
    def __init__(
        ...
        *,
        input: global___Relation | None = ...,
        columns: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        column_names: collections.abc.Iterable[builtins.str] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["column_names", b"column_names", "columns", b"columns", "input", b"input"]) -> None: ...
...
class Deduplicate(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_all_columns_as_keys", b"_all_columns_as_keys", "_within_watermark", b"_within_watermark", "all_columns_as_keys", b"all_columns_as_keys", "input", b"input", "within_watermark", b"within_watermark"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_all_columns_as_keys", b"_all_columns_as_keys", "_within_watermark", b"_within_watermark", "all_columns_as_keys", b"all_columns_as_keys", "column_names", b"column_names", "input", b"input", "within_watermark", b"within_watermark"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_all_columns_as_keys", b"_all_columns_as_keys"]) -> typing_extensions.Literal["all_columns_as_keys"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_within_watermark", b"_within_watermark"]) -> typing_extensions.Literal["within_watermark"] | None: ...
...
class LocalRelation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_data", b"_data", "_schema", b"_schema", "data", b"data", "schema", b"schema"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_data", b"_data", "_schema", b"_schema", "data", b"data", "schema", b"schema"]) -> None: ...
    @typing.overload
...
class CachedRemoteRelation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["relation_id", b"relation_id"]) -> None: ...
...
class Sample(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_seed", b"_seed", "_with_replacement", b"_with_replacement", "input", b"input", "seed", b"seed", "with_replacement", b"with_replacement"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_seed", b"_seed", "_with_replacement", b"_with_replacement", "deterministic_order", b"deterministic_order", "input", b"input", "lower_bound", b"lower_bound", "seed", b"seed", "upper_bound", b"upper_bound", "with_replacement", b"with_replacement"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_seed", b"_seed"]) -> typing_extensions.Literal["seed"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_with_replacement", b"_with_replacement"]) -> typing_extensions.Literal["with_replacement"] | None: ...
...
class Range(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_num_partitions", b"_num_partitions", "_start", b"_start", "num_partitions", b"num_partitions", "start", b"start"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_num_partitions", b"_num_partitions", "_start", b"_start", "end", b"end", "num_partitions", b"num_partitions", "start", b"start", "step", b"step"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_num_partitions", b"_num_partitions"]) -> typing_extensions.Literal["num_partitions"] | None: ...
    @typing.overload
...
class SubqueryAlias(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["alias", b"alias", "input", b"input", "qualifier", b"qualifier"]) -> None: ...
...
class Repartition(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_shuffle", b"_shuffle", "input", b"input", "shuffle", b"shuffle"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_shuffle", b"_shuffle", "input", b"input", "num_partitions", b"num_partitions", "shuffle", b"shuffle"]) -> None: ...
...
class ShowString(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["input", b"input", "num_rows", b"num_rows", "truncate", b"truncate", "vertical", b"vertical"]) -> None: ...
...
class HtmlString(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["input", b"input", "num_rows", b"num_rows", "truncate", b"truncate"]) -> None: ...
...
class StatSummary(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["input", b"input", "statistics", b"statistics"]) -> None: ...
...
class StatDescribe(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cols", b"cols", "input", b"input"]) -> None: ...
...
class StatCrosstab(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["col1", b"col1", "col2", b"col2", "input", b"input"]) -> None: ...
...
class StatCorr(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_method", b"_method", "input", b"input", "method", b"method"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_method", b"_method", "col1", b"col1", "col2", b"col2", "input", b"input", "method", b"method"]) -> None: ...
...
class StatApproxQuantile(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cols", b"cols", "input", b"input", "probabilities", b"probabilities", "relative_error", b"relative_error"]) -> None: ...
...
class StatFreqItems(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_support", b"_support", "input", b"input", "support", b"support"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_support", b"_support", "cols", b"cols", "input", b"input", "support", b"support"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_support", b"_support"]) -> typing_extensions.Literal["support"] | None: ...
...
class StatSampleBy(google.protobuf.message.Message):
    ...
    class Fraction(google.protobuf.message.Message):
        ...
        @property
        def stratum(self) -> spark.connect.expressions_pb2.Expression.Literal:
        ...
        def __init__(
            self,
            *,
            stratum: spark.connect.expressions_pb2.Expression.Literal | None = ...,
            fraction: builtins.float = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["stratum", b"stratum"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["fraction", b"fraction", "stratum", b"stratum"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["_seed", b"_seed", "col", b"col", "input", b"input", "seed", b"seed"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_seed", b"_seed", "col", b"col", "fractions", b"fractions", "input", b"input", "seed", b"seed"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_seed", b"_seed"]) -> typing_extensions.Literal["seed"] | None: ...
...
class NAFill(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cols", b"cols", "input", b"input", "values", b"values"]) -> None: ...
...
class NADrop(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_min_non_nulls", b"_min_non_nulls", "input", b"input", "min_non_nulls", b"min_non_nulls"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_min_non_nulls", b"_min_non_nulls", "cols", b"cols", "input", b"input", "min_non_nulls", b"min_non_nulls"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_min_non_nulls", b"_min_non_nulls"]) -> typing_extensions.Literal["min_non_nulls"] | None: ...
...
class NAReplace(google.protobuf.message.Message):
    ...
    class Replacement(google.protobuf.message.Message):
        ...
        @property
        def old_value(self) -> spark.connect.expressions_pb2.Expression.Literal:
            """(Required) The old value.

            Only 4 data types are supported now: null, bool, double, string.
            """
        @property
        def new_value(self) -> spark.connect.expressions_pb2.Expression.Literal:
        ...
        def __init__(
            self,
            *,
            old_value: spark.connect.expressions_pb2.Expression.Literal | None = ...,
            new_value: spark.connect.expressions_pb2.Expression.Literal | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["new_value", b"new_value", "old_value", b"old_value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["new_value", b"new_value", "old_value", b"old_value"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cols", b"cols", "input", b"input", "replacements", b"replacements"]) -> None: ...
...
class ToDF(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["column_names", b"column_names", "input", b"input"]) -> None: ...
...
class WithColumnsRenamed(google.protobuf.message.Message):
    ...
    class Rename(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["col_name", b"col_name", "new_col_name", b"new_col_name"]) -> None: ...
    ...
    def rename_columns_map(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, builtins.str]:
        ...
        """
    @property
    def renames(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___WithColumnsRenamed.Rename]: ...
    def __init__(
        self,
        *,
        input: global___Relation | None = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["input", b"input", "rename_columns_map", b"rename_columns_map", "renames", b"renames"]) -> None: ...
...
class WithColumns(google.protobuf.message.Message):
    ...
    def input(self) -> global___Relation:
        """(Required) The input relation."""
    @property
    def aliases(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression.Alias]:
        """(Required)
    ...
    def __init__(
        ...
        *,
        input: global___Relation | None = ...,
        aliases: collections.abc.Iterable[spark.connect.expressions_pb2.Expression.Alias] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["aliases", b"aliases", "input", b"input"]) -> None: ...
...
class WithWatermark(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["delay_threshold", b"delay_threshold", "event_time", b"event_time", "input", b"input"]) -> None: ...
...
class Hint(google.protobuf.message.Message):
    ...
    """
    @property
    def parameters(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
    ...
    def __init__(
        ...
        *,
        input: global___Relation | None = ...,
        name: builtins.str = ...,
        parameters: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["input", b"input", "name", b"name", "parameters", b"parameters"]) -> None: ...
...
class Unpivot(google.protobuf.message.Message):
    ...
    class Values(google.protobuf.message.Message):
        ...
        VALUES_FIELD_NUMBER: builtins.int
        @property
        def values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]: ...
        def __init__(
            self,
            *,
            values: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        ) -> None: ...
    ...
    def input(self) -> global___Relation:
        """(Required) The input relation."""
    @property
    def ids(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
        """(Required) Id columns."""
    @property
    ...
    def __init__(
        ...
        *,
        input: global___Relation | None = ...,
        ids: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        values: global___Unpivot.Values | None = ...,
        variable_column_name: builtins.str = ...,
        value_column_name: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_values", b"_values", "input", b"input", "values", b"values"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_values", b"_values", "ids", b"ids", "input", b"input", "value_column_name", b"value_column_name", "values", b"values", "variable_column_name", b"variable_column_name"]) -> None: ...
...
class ToSchema(google.protobuf.message.Message):
    ...
    def input(self) -> global___Relation:
        """(Required) The input relation."""
    @property
    def schema(self) -> spark.connect.types_pb2.DataType:
    ...
    def __init__(
        ...
        *,
        input: global___Relation | None = ...,
        schema: spark.connect.types_pb2.DataType | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input", "schema", b"schema"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["input", b"input", "schema", b"schema"]) -> None: ...
...
class RepartitionByExpression(google.protobuf.message.Message):
    ...
    def input(self) -> global___Relation:
        """(Required) The input relation."""
    @property
    def partition_exprs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
    ...
    def __init__(
        ...
        *,
        input: global___Relation | None = ...,
        partition_exprs: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        num_partitions: builtins.int | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_num_partitions", b"_num_partitions", "input", b"input", "num_partitions", b"num_partitions"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_num_partitions", b"_num_partitions", "input", b"input", "num_partitions", b"num_partitions", "partition_exprs", b"partition_exprs"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_num_partitions", b"_num_partitions"]) -> typing_extensions.Literal["num_partitions"] | None: ...
...
class MapPartitions(google.protobuf.message.Message):
    ...
    @property
    def func(self) -> spark.connect.expressions_pb2.CommonInlineUserDefinedFunction:
    ...
    def __init__(
        ...
        *,
        input: global___Relation | None = ...,
        func: spark.connect.expressions_pb2.CommonInlineUserDefinedFunction | None = ...,
        is_barrier: builtins.bool | None = ...,
        profile_id: builtins.int | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_is_barrier", b"_is_barrier", "_profile_id", b"_profile_id", "func", b"func", "input", b"input", "is_barrier", b"is_barrier", "profile_id", b"profile_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_is_barrier", b"_is_barrier", "_profile_id", b"_profile_id", "func", b"func", "input", b"input", "is_barrier", b"is_barrier", "profile_id", b"profile_id"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_is_barrier", b"_is_barrier"]) -> typing_extensions.Literal["is_barrier"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_profile_id", b"_profile_id"]) -> typing_extensions.Literal["profile_id"] | None: ...
...
class GroupMap(google.protobuf.message.Message):
    ...
    def func(self) -> spark.connect.expressions_pb2.CommonInlineUserDefinedFunction:
        """(Required) Input user-defined function."""
    @property
    def sorting_expressions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
    ...
    def initial_input(self) -> global___Relation:
        ...
        """
    @property
    def initial_grouping_expressions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
    ...
    def __init__(
        ...
        *,
        ...
        grouping_expressions: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        func: spark.connect.expressions_pb2.CommonInlineUserDefinedFunction | None = ...,
        sorting_expressions: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        initial_input: global___Relation | None = ...,
        initial_grouping_expressions: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        is_map_groups_with_state: builtins.bool | None = ...,
        output_mode: builtins.str | None = ...,
        timeout_conf: builtins.str | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_is_map_groups_with_state", b"_is_map_groups_with_state", "_output_mode", b"_output_mode", "_timeout_conf", b"_timeout_conf", "func", b"func", "initial_input", b"initial_input", "input", b"input", "is_map_groups_with_state", b"is_map_groups_with_state", "output_mode", b"output_mode", "timeout_conf", b"timeout_conf"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_is_map_groups_with_state", b"_is_map_groups_with_state", "_output_mode", b"_output_mode", "_timeout_conf", b"_timeout_conf", "func", b"func", "grouping_expressions", b"grouping_expressions", "initial_grouping_expressions", b"initial_grouping_expressions", "initial_input", b"initial_input", "input", b"input", "is_map_groups_with_state", b"is_map_groups_with_state", "output_mode", b"output_mode", "sorting_expressions", b"sorting_expressions", "timeout_conf", b"timeout_conf"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_is_map_groups_with_state", b"_is_map_groups_with_state"]) -> typing_extensions.Literal["is_map_groups_with_state"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_output_mode", b"_output_mode"]) -> typing_extensions.Literal["output_mode"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_timeout_conf", b"_timeout_conf"]) -> typing_extensions.Literal["timeout_conf"] | None: ...
...
class CoGroupMap(google.protobuf.message.Message):
    ...
    @property
    def input_grouping_expressions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
    ...
    @property
    def other_grouping_expressions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
        """Expressions for grouping keys of the other input relation."""
    @property
    def func(self) -> spark.connect.expressions_pb2.CommonInlineUserDefinedFunction:
        """(Required) Input user-defined function."""
    @property
    def input_sorting_expressions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
        """(Optional) Expressions for sorting. Only used by Scala Sorted CoGroup Map API."""
    @property
    def other_sorting_expressions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
        """(Optional) Expressions for sorting. Only used by Scala Sorted CoGroup Map API."""
    def __init__(
        self,
        *,
        input: global___Relation | None = ...,
        input_grouping_expressions: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        other: global___Relation | None = ...,
        other_grouping_expressions: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        func: spark.connect.expressions_pb2.CommonInlineUserDefinedFunction | None = ...,
        input_sorting_expressions: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        other_sorting_expressions: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["func", b"func", "input", b"input", "other", b"other"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["func", b"func", "input", b"input", "input_grouping_expressions", b"input_grouping_expressions", "input_sorting_expressions", b"input_sorting_expressions", "other", b"other", "other_grouping_expressions", b"other_grouping_expressions", "other_sorting_expressions", b"other_sorting_expressions"]) -> None: ...
...
class ApplyInPandasWithState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["func", b"func", "input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["func", b"func", "grouping_expressions", b"grouping_expressions", "input", b"input", "output_mode", b"output_mode", "output_schema", b"output_schema", "state_schema", b"state_schema", "timeout_conf", b"timeout_conf"]) -> None: ...
...
class CommonInlineUserDefinedTableFunction(google.protobuf.message.Message):
    ...
    @property
    def arguments(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
    ...
    def __init__(
        ...
        *,
        function_name: builtins.str = ...,
        deterministic: builtins.bool = ...,
        arguments: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
        python_udtf: global___PythonUDTF | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["function", b"function", "python_udtf", b"python_udtf"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["arguments", b"arguments", "deterministic", b"deterministic", "function", b"function", "function_name", b"function_name", "python_udtf", b"python_udtf"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["function", b"function"]) -> typing_extensions.Literal["python_udtf"] | None: ...
...
class PythonUDTF(google.protobuf.message.Message):
    ...
    @property
    def return_type(self) -> spark.connect.types_pb2.DataType:
    ...
    def __init__(
        self,
        *,
        return_type: spark.connect.types_pb2.DataType | None = ...,
        eval_type: builtins.int = ...,
        command: builtins.bytes = ...,
        python_ver: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_return_type", b"_return_type", "return_type", b"return_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_return_type", b"_return_type", "command", b"command", "eval_type", b"eval_type", "python_ver", b"python_ver", "return_type", b"return_type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_return_type", b"_return_type"]) -> typing_extensions.Literal["return_type"] | None: ...
...
class CommonInlineUserDefinedDataSource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["data_source", b"data_source", "python_data_source", b"python_data_source"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data_source", b"data_source", "name", b"name", "python_data_source", b"python_data_source"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["data_source", b"data_source"]) -> typing_extensions.Literal["python_data_source"] | None: ...
...
class PythonDataSource(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["command", b"command", "python_ver", b"python_ver"]) -> None: ...
...
class CollectMetrics(google.protobuf.message.Message):
    ...
    @property
    def metrics(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[spark.connect.expressions_pb2.Expression]:
    ...
    def __init__(
        ...
        *,
        input: global___Relation | None = ...,
        name: builtins.str = ...,
        metrics: collections.abc.Iterable[spark.connect.expressions_pb2.Expression] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["input", b"input", "metrics", b"metrics", "name", b"name"]) -> None: ...
...
class Parse(google.protobuf.message.Message):
    ...
    class _ParseFormatEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Parse._ParseFormat.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def HasField(self, field_name: typing_extensions.Literal["_schema", b"_schema", "input", b"input", "schema", b"schema"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_schema", b"_schema", "format", b"format", "input", b"input", "options", b"options", "schema", b"schema"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_schema", b"_schema"]) -> typing_extensions.Literal["schema"] | None: ...
...
class AsOfJoin(google.protobuf.message.Message):
    ...
    def right(self) -> global___Relation:
        """(Required) Right input relation for a Join."""
    @property
    def left_as_of(self) -> spark.connect.expressions_pb2.Expression:
        """(Required) Field to join on in left DataFrame"""
    @property
    def right_as_of(self) -> spark.connect.expressions_pb2.Expression:
        """(Required) Field to join on in right DataFrame"""
    @property
    def join_expr(self) -> spark.connect.expressions_pb2.Expression:
        """(Optional) The join condition. Could be unset when `using_columns` is utilized.
    ...
    """(Required) The join type."""
    @property
    def tolerance(self) -> spark.connect.expressions_pb2.Expression:
    ...
    def __init__(
        ...
        *,
        left: global___Relation | None = ...,
        right: global___Relation | None = ...,
        left_as_of: spark.connect.expressions_pb2.Expression | None = ...,
        right_as_of: spark.connect.expressions_pb2.Expression | None = ...,
        join_expr: spark.connect.expressions_pb2.Expression | None = ...,
        using_columns: collections.abc.Iterable[builtins.str] | None = ...,
        join_type: builtins.str = ...,
        tolerance: spark.connect.expressions_pb2.Expression | None = ...,
        allow_exact_matches: builtins.bool = ...,
        direction: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["join_expr", b"join_expr", "left", b"left", "left_as_of", b"left_as_of", "right", b"right", "right_as_of", b"right_as_of", "tolerance", b"tolerance"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["allow_exact_matches", b"allow_exact_matches", "direction", b"direction", "join_expr", b"join_expr", "join_type", b"join_type", "left", b"left", "left_as_of", b"left_as_of", "right", b"right", "right_as_of", b"right_as_of", "tolerance", b"tolerance", "using_columns", b"using_columns"]) -> None: ...
