...
class DataType(google.protobuf.message.Message):
    ...
    class Boolean(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["type_variation_reference", b"type_variation_reference"]) -> None: ...
    ...
    class String(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["collation_id", b"collation_id", "type_variation_reference", b"type_variation_reference"]) -> None: ...
    ...
    class YearMonthInterval(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_end_field", b"_end_field", "_start_field", b"_start_field", "end_field", b"end_field", "start_field", b"start_field"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_end_field", b"_end_field", "_start_field", b"_start_field", "end_field", b"end_field", "start_field", b"start_field", "type_variation_reference", b"type_variation_reference"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_end_field", b"_end_field"]) -> typing_extensions.Literal["end_field"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_start_field", b"_start_field"]) -> typing_extensions.Literal["start_field"] | None: ...
    ...
    class Char(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["length", b"length", "type_variation_reference", b"type_variation_reference"]) -> None: ...
    ...
    class Decimal(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["_precision", b"_precision", "_scale", b"_scale", "precision", b"precision", "scale", b"scale", "type_variation_reference", b"type_variation_reference"]) -> None: ...
        @typing.overload
    ...
    class StructField(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_metadata", b"_metadata", "data_type", b"data_type", "metadata", b"metadata"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_metadata", b"_metadata", "data_type", b"data_type", "metadata", b"metadata", "name", b"name", "nullable", b"nullable"]) -> None: ...
    ...
    class Struct(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["fields", b"fields", "type_variation_reference", b"type_variation_reference"]) -> None: ...
    ...
    class Array(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["contains_null", b"contains_null", "element_type", b"element_type", "type_variation_reference", b"type_variation_reference"]) -> None: ...
    ...
    class Map(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["key_type", b"key_type", "type_variation_reference", b"type_variation_reference", "value_contains_null", b"value_contains_null", "value_type", b"value_type"]) -> None: ...
    ...
    class UDT(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_jvm_class", b"_jvm_class", "_python_class", b"_python_class", "_serialized_python_class", b"_serialized_python_class", "jvm_class", b"jvm_class", "python_class", b"python_class", "serialized_python_class", b"serialized_python_class", "sql_type", b"sql_type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_jvm_class", b"_jvm_class", "_python_class", b"_python_class", "_serialized_python_class", b"_serialized_python_class", "jvm_class", b"jvm_class", "python_class", b"python_class", "serialized_python_class", b"serialized_python_class", "sql_type", b"sql_type", "type", b"type"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_jvm_class", b"_jvm_class"]) -> typing_extensions.Literal["jvm_class"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_python_class", b"_python_class"]) -> typing_extensions.Literal["python_class"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_serialized_python_class", b"_serialized_python_class"]) -> typing_extensions.Literal["serialized_python_class"] | None: ...
    ...
    class Unparsed(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["data_type_string", b"data_type_string"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["array", b"array", "binary", b"binary", "boolean", b"boolean", "byte", b"byte", "calendar_interval", b"calendar_interval", "char", b"char", "date", b"date", "day_time_interval", b"day_time_interval", "decimal", b"decimal", "double", b"double", "float", b"float", "integer", b"integer", "kind", b"kind", "long", b"long", "map", b"map", "null", b"null", "short", b"short", "string", b"string", "struct", b"struct", "timestamp", b"timestamp", "timestamp_ntz", b"timestamp_ntz", "udt", b"udt", "unparsed", b"unparsed", "var_char", b"var_char", "variant", b"variant", "year_month_interval", b"year_month_interval"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["array", b"array", "binary", b"binary", "boolean", b"boolean", "byte", b"byte", "calendar_interval", b"calendar_interval", "char", b"char", "date", b"date", "day_time_interval", b"day_time_interval", "decimal", b"decimal", "double", b"double", "float", b"float", "integer", b"integer", "kind", b"kind", "long", b"long", "map", b"map", "null", b"null", "short", b"short", "string", b"string", "struct", b"struct", "timestamp", b"timestamp", "timestamp_ntz", b"timestamp_ntz", "udt", b"udt", "unparsed", b"unparsed", "var_char", b"var_char", "variant", b"variant", "year_month_interval", b"year_month_interval"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["kind", b"kind"]) -> typing_extensions.Literal["null", "binary", "boolean", "byte", "short", "integer", "long", "float", "double", "decimal", "string", "char", "var_char", "date", "timestamp", "timestamp_ntz", "calendar_interval", "year_month_interval", "day_time_interval", "array", "struct", "map", "variant", "udt", "unparsed"] | None: ...
