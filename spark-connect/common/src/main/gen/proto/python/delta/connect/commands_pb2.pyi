...
class DeltaCommand(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["add_feature_support", b"add_feature_support", "clone_table", b"clone_table", "command_type", b"command_type", "create_delta_table", b"create_delta_table", "drop_feature_support", b"drop_feature_support", "generate", b"generate", "upgrade_table_protocol", b"upgrade_table_protocol", "vacuum_table", b"vacuum_table"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["add_feature_support", b"add_feature_support", "clone_table", b"clone_table", "command_type", b"command_type", "create_delta_table", b"create_delta_table", "drop_feature_support", b"drop_feature_support", "generate", b"generate", "upgrade_table_protocol", b"upgrade_table_protocol", "vacuum_table", b"vacuum_table"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["command_type", b"command_type"]) -> typing_extensions.Literal["clone_table", "vacuum_table", "upgrade_table_protocol", "generate", "create_delta_table", "add_feature_support", "drop_feature_support"] | None: ...
...
class CloneTable(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["is_shallow", b"is_shallow", "properties", b"properties", "replace", b"replace", "table", b"table", "target", b"target", "timestamp", b"timestamp", "version", b"version", "version_or_timestamp", b"version_or_timestamp"]) -> None: ...
...
class VacuumTable(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_retention_hours", b"_retention_hours", "retention_hours", b"retention_hours", "table", b"table"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_retention_hours", b"_retention_hours", "retention_hours", b"retention_hours", "table", b"table"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_retention_hours", b"_retention_hours"]) -> typing_extensions.Literal["retention_hours"] | None: ...
...
class UpgradeTableProtocol(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["reader_version", b"reader_version", "table", b"table", "writer_version", b"writer_version"]) -> None: ...
...
class Generate(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["table", b"table"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["mode", b"mode", "table", b"table"]) -> None: ...
...
class CreateDeltaTable(google.protobuf.message.Message):
    ...
    class _ModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[CreateDeltaTable._Mode.ValueType], builtins.type):  # noqa: F821
    ...
    class Column(google.protobuf.message.Message):
        ...
        class IdentityInfo(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing_extensions.Literal["allow_explicit_insert", b"allow_explicit_insert", "start", b"start", "step", b"step"]) -> None: ...
        ...
        def HasField(self, field_name: typing_extensions.Literal["_comment", b"_comment", "_generated_always_as", b"_generated_always_as", "_identity_info", b"_identity_info", "comment", b"comment", "data_type", b"data_type", "generated_always_as", b"generated_always_as", "identity_info", b"identity_info"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_comment", b"_comment", "_generated_always_as", b"_generated_always_as", "_identity_info", b"_identity_info", "comment", b"comment", "data_type", b"data_type", "generated_always_as", b"generated_always_as", "identity_info", b"identity_info", "name", b"name", "nullable", b"nullable"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_comment", b"_comment"]) -> typing_extensions.Literal["comment"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_generated_always_as", b"_generated_always_as"]) -> typing_extensions.Literal["generated_always_as"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_identity_info", b"_identity_info"]) -> typing_extensions.Literal["identity_info"] | None: ...
    ...
    @property
    def columns(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CreateDeltaTable.Column]:
    ...
    def HasField(self, field_name: typing_extensions.Literal["_comment", b"_comment", "_location", b"_location", "_table_name", b"_table_name", "comment", b"comment", "location", b"location", "table_name", b"table_name"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_comment", b"_comment", "_location", b"_location", "_table_name", b"_table_name", "clustering_columns", b"clustering_columns", "columns", b"columns", "comment", b"comment", "location", b"location", "mode", b"mode", "partitioning_columns", b"partitioning_columns", "properties", b"properties", "table_name", b"table_name"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_comment", b"_comment"]) -> typing_extensions.Literal["comment"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_location", b"_location"]) -> typing_extensions.Literal["location"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_table_name", b"_table_name"]) -> typing_extensions.Literal["table_name"] | None: ...
...
class AddFeatureSupport(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["table", b"table"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["feature_name", b"feature_name", "table", b"table"]) -> None: ...
...
class DropFeatureSupport(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_truncate_history", b"_truncate_history", "table", b"table", "truncate_history", b"truncate_history"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_truncate_history", b"_truncate_history", "feature_name", b"feature_name", "table", b"table", "truncate_history", b"truncate_history"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_truncate_history", b"_truncate_history"]) -> typing_extensions.Literal["truncate_history"] | None: ...
