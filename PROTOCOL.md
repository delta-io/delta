...
- [Iceberg Compatibility V2](#iceberg-compatibility-v2)
  - [Writer Requirements for IcebergCompatV2](#writer-requirements-for-icebergcompatv2)
...
- [In-Commit Timestamps](#in-commit-timestamps)
  - [Writer Requirements for In-Commit Timestamps](#writer-requirements-for-in-commit-timestamps)
  - [Recommendations for Readers of Tables with In-Commit Timestamps](#recommendations-for-readers-of-tables-with-in-commit-timestamps)
- [Type Widening](#type-widening)
  - [Writer Requirements for Type Widening](#writer-requirements-for-type-widening)
  - [Reader Requirements for Type Widening](#reader-requirements-for-type-widening)
