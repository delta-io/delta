...
/** Wrapper class for inferred and explicit CDF files. */
public class CDCDataFile {
  private final AddFile addFile;
  private final String changeType;
  private final long commitTimestamp;

  /** Create a CDCDataFile inferred from an AddFile action. */
  public static CDCDataFile fromAddFile(AddFile addFile, String changeType, long commitTimestamp) {
    return new CDCDataFile(addFile, changeType, commitTimestamp);
  }
