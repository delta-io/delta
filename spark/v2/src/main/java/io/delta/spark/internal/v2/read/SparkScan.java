...
public class SparkScan implements Scan, SupportsReportStatistics, SupportsRuntimeV2Filtering {
   ...
   * startingVersion, startingTimestamp, maxFilesPerTrigger, maxBytesPerTrigger, ignoreDeletes, and
   * skipChangeCommits are supported. User-defined custom options (not in DeltaOptions) are allowed
   * to pass through.
   */
