...
object SuiteGeneratorConfig {
  private object Dims {
    ...
    val V2_IN_MEMORY_TABLE_DELETE =
      DimensionMixin("DeleteSuiteInMemoryTestTable", alias = Some("InMemoryTable"))
    ...
    TestGroup(
      ...
      testConfigs = List(
        ...
        TestConfig(
          ...
          List(
            List(Dims.DELETE_SQL, Dims.NAME_BASED, Dims.V2_IN_MEMORY_TABLE_DELETE)
          )
        ),
        TestConfig(
