...
public final class ColumnTypeChangeSupport {
  ...
  public static boolean supportsTypeChange(
    ...
    return isSupportedWidening(conf, metadata, fromType, toType)
        // DSv1 fails if a condition prevents widening a data type instead of ignoring that change.
        // Ignoring is more user-friendly, DSv1 only fails because ignoring is too difficult there.
