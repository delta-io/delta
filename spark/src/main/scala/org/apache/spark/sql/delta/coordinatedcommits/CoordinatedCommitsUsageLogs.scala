...
/** Class containing usage logs emitted by Catalog Managed. */
object CatalogManagedUsageLogs {
  /** Common prefix for all catalog-managed usage logs. */
  val PREFIX = "delta.catalogManaged"
