...
/**
 * Implementation of DeltaProtocolMetadataWrapper for delta-spark v1 Protocol and Metadata.
 *
 * This class adapts the existing delta-spark Protocol and Metadata actions to the
 * DeltaProtocolMetadataWrapper interface, enabling code reuse in DeltaParquetFileFormat.
 */
case class DeltaProtocolMetadataWrapperV1(
    protocol: Protocol,
    metadata: Metadata) extends DeltaProtocolMetadataWrapper {
