...
/**
 * Base class for Delta Parquet file format that uses DeltaProtocolMetadataWrapper abstraction.
...
abstract class DeltaParquetFileFormatBase(
    protected val protocolMetadataWrapper: DeltaProtocolMetadataWrapper,
...
case class DeltaParquetFileFormat(
  ...
  extends DeltaParquetFileFormatBase(
    protocolMetadataWrapper = DeltaProtocolMetadataWrapperV1(protocol, metadata),
