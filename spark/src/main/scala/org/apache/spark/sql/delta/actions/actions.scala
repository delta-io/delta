...
object CommitInfo {
   ...
   * parameter deserialization was broken before. These legacy values are the
   * same as the original broken version.
   */
 ...
 *
 * High level: Previously, the deserialization of operationParameters was broken.
 ...
 *     "\"abc\"". We want to the deserialization process to recover the input of the serialization
 *     process, i.e. (String -> JsonEncodedString(Any)).
 *
