...
package org.apache.spark.sql.delta.generatedsuites.readcdcv2
...
class DeleteCDCPathBasedRowTrackingOnDVOffChangelogV2CDCUtilSuite
  extends DeleteCDCTests
  with DeltaDMLTestUtilsPathBased
  with RowTrackingEnabled
  with PersistentDVDisabled
  with ChangelogV2CDCUtilMixin

class DeleteCDCPathBasedRowTrackingOnDVOnChangelogV2CDCUtilSuite
  extends DeleteCDCTests
  with DeltaDMLTestUtilsPathBased
  with RowTrackingEnabled
