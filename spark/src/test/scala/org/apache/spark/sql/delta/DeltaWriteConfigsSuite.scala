...
class DeltaWriteConfigsSuite extends QueryTest
  ...
  */
  ...
  Note: With auto-normalization, keys without "delta." prefix are normalized to include the prefix.
  +---------------+--------------+-------------------------------------+-------------------------+----------------------+-----+-----------------------------------------------------------------------------------------------+
  ...
  +---------------+--------------+-------------------------------------+-------------------------+----------------------+-----+-----------------------------------------------------------------------------------------------+
  |path           |create        |false                                |false                    |true                  |false|delta.deletedFileRetentionDuration -> interval 2 weeks,delta.dataSkippingNumIndexedCols -> 33  |
  |path           |replace       |false                                |false                    |true                  |false|delta.deletedFileRetentionDuration -> interval 2 weeks,delta.dataSkippingNumIndexedCols -> 33  |
  |path           |c_or_r_create |false                                |false                    |true                  |false|delta.deletedFileRetentionDuration -> interval 2 weeks,delta.dataSkippingNumIndexedCols -> 33  |
  |path           |c_or_r_replace|false                                |false                    |false                 |true |                                                                                               |
  |table          |create        |false                                |false                    |true                  |false|delta.dataSkippingNumIndexedCols -> 33,delta.deletedFileRetentionDuration -> interval 2 weeks  |
  |table          |replace       |false                                |false                    |true                  |false|delta.deletedFileRetentionDuration -> interval 2 weeks,delta.dataSkippingNumIndexedCols -> 33  |
  |table          |c_or_r_create |false                                |false                    |true                  |false|delta.deletedFileRetentionDuration -> interval 2 weeks,delta.dataSkippingNumIndexedCols -> 33  |
  |table          |c_or_r_replace|false                                |false                    |true                  |false|delta.deletedFileRetentionDuration -> interval 2 weeks,delta.dataSkippingNumIndexedCols -> 33  |
  +---------------+--------------+-------------------------------------+-------------------------+----------------------+-----+-----------------------------------------------------------------------------------------------+
  */
  // scalastyle:on line.size.limit
  Seq("path", "table").foreach { outputLoc =>
          ...
          withTable("tbl") {
            ...
            log match {
              ...
              case _ =>
                ...
                // With auto-normalization, keys without "delta." prefix are normalized
                // to include the prefix, so the original key won't be found
                assert(!answer_no_prefix_lowercase)
                assert(!answer_no_prefix)  // normalized to delta.dataSkippingNumIndexedCols
                assert(answer_prefix)
  ...
  /*
  SQL Test Output
  Note: With auto-normalization, logRetentionDuration is normalized to delta.logRetentionDuration.
  +---------------+-------------------------+--------------+---------+-------------------------+----------------------+--------------------------------+-----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  ...
  |path           |options                  |create        |false    |false                    |true                  |N/A                             |N/A                          |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.dataSkippingNumIndexedCols -> 33,option.delta.deletedFileRetentionDuration -> interval 2 weeks,option.dataSkippingNumIndexedCols -> 33                                                                  |
  ...
  |path           |tblproperties            |create        |true     |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |path           |tblproperties            |create        |false    |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |path           |tblproperties            |replace       |true     |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |path           |tblproperties            |replace       |false    |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |path           |tblproperties            |c_or_r_create |true     |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |path           |tblproperties            |c_or_r_create |false    |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |path           |tblproperties            |c_or_r_replace|true     |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |path           |tblproperties            |c_or_r_replace|false    |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |path           |options_and_tblproperties|create        |true     |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |path           |options_and_tblproperties|create        |false    |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.dataSkippingNumIndexedCols -> 33,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20,option.delta.deletedFileRetentionDuration -> interval 2 weeks,option.dataSkippingNumIndexedCols -> 33|
  |path           |options_and_tblproperties|replace       |true     |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |path           |options_and_tblproperties|replace       |false    |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |path           |options_and_tblproperties|c_or_r_create |true     |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |path           |options_and_tblproperties|c_or_r_create |false    |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |path           |options_and_tblproperties|c_or_r_replace|true     |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |path           |options_and_tblproperties|c_or_r_replace|false    |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |table          |options                  |create        |true     |false                    |true                  |N/A                             |N/A                          |delta.deletedFileRetentionDuration -> interval 2 weeks                                                                                                                                                                                                               |
  |table          |options                  |create        |false    |false                    |true                  |N/A                             |N/A                          |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.dataSkippingNumIndexedCols -> 33,option.delta.deletedFileRetentionDuration -> interval 2 weeks,option.dataSkippingNumIndexedCols -> 33                                                                  |
  ...
  |table          |tblproperties            |create        |true     |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |table          |tblproperties            |create        |false    |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |table          |tblproperties            |replace       |true     |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |table          |tblproperties            |replace       |false    |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |table          |tblproperties            |c_or_r_create |true     |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |table          |tblproperties            |c_or_r_create |false    |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |table          |tblproperties            |c_or_r_replace|true     |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |table          |tblproperties            |c_or_r_replace|false    |N/A                      |N/A                   |false                           |true                         |delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                                                                        |
  |table          |options_and_tblproperties|create        |true     |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |table          |options_and_tblproperties|create        |false    |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.dataSkippingNumIndexedCols -> 33,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20,option.delta.deletedFileRetentionDuration -> interval 2 weeks,option.dataSkippingNumIndexedCols -> 33|
  |table          |options_and_tblproperties|replace       |true     |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |table          |options_and_tblproperties|replace       |false    |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |table          |options_and_tblproperties|c_or_r_create |true     |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |table          |options_and_tblproperties|c_or_r_create |false    |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |table          |options_and_tblproperties|c_or_r_replace|true     |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  |table          |options_and_tblproperties|c_or_r_replace|false    |false                    |true                  |false                           |true                         |delta.deletedFileRetentionDuration -> interval 2 weeks,delta.logRetentionDuration -> interval 60 days,delta.checkpointInterval -> 20                                                                                                                                 |
  +---------------+-------------------------+--------------+---------+-------------------------+----------------------+--------------------------------+-----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  */
  // scalastyle:on line.size.limit
  Seq("path", "table").foreach { outputLoc =>
              ...
              withTable("tbl", "other") {
                ...
                if (option_was_set) {
                  ...
                  if (sqlOp == "create" && !useAsSelectStmt) {
                    // With auto-normalization, dataSkippingNumIndexedCols is normalized to
                    // delta.dataSkippingNumIndexedCols, so the original key won't be found
                ...
                if (tblproperties_was_set) {
                  ...
                  // With auto-normalization, logRetentionDuration is normalized to
                  // delta.logRetentionDuration, so the original key won't be found
