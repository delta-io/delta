...
<<<<<<< HEAD:spark/src/test/scala/org/apache/spark/sql/delta/MergeIntoSuiteBase.scala
...
>>>>>>> 73f1a6965 (set active session for commands):core/src/test/scala/org/apache/spark/sql/delta/MergeIntoSuiteBase.scala
}
