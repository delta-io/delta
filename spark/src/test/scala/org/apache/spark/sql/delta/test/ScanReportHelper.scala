...
/**
 * A helper trait used by test classes that want to collect the scans (i.e. [[FileSourceScanLike]])
...
trait ScanReportHelper extends SharedSparkSession with AdaptiveSparkPlanHelper {
   ...
   */
  private def collectScans(plan: SparkPlan): Seq[FileSourceScanLike] = {
    collectWithSubqueries(plan)({
      case fs: FileSourceScanLike => Seq(fs)
   ...
   *
   * Specifically, this listener will check for any [[FileSourceScanLike]] generated during query
