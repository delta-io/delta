...
class DeltaLogMinorCompactionWithCatalogManagedBatch1Suite
...
class DeltaLogMinorCompactionWithCatalogManagedBatch2Suite
  extends DeltaLogMinorCompactionSuite {
...
class DeltaLogMinorCompactionWithCatalogManagedBatch100Suite
    extends DeltaLogMinorCompactionSuite {
