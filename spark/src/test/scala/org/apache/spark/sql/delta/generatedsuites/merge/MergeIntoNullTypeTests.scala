...
package org.apache.spark.sql.delta.generatedsuites.merge

import org.apache.spark.sql.delta._
import org.apache.spark.sql.delta.cdc._
import org.apache.spark.sql.delta.rowid._

class MergeIntoNullTypeSQLNameBasedSuite
  extends MergeIntoNullTypeTests
  with MergeIntoSQLMixin
  with DeltaDMLTestUtilsNameBased

class MergeIntoNullTypeSQLPathBasedColMapIdModeSuite
  extends MergeIntoNullTypeTests
  with MergeIntoSQLMixin
...
class MergeIntoNullTypeSQLPathBasedColMapNameModeSuite
  extends MergeIntoNullTypeTests
  with MergeIntoSQLMixin
  with DeltaDMLTestUtilsPathBased
...
class MergeIntoNullTypeScalaSuite extends MergeIntoNullTypeTests with MergeIntoScalaMixin
