...
trait SparkTestSuite
  ...
  // delta shim addition to keep 'binary-compatible' with old SparkTestSuite
  protected override def checkError(
    ...
    super.checkError(exception, condition, sqlState, parameters, matchPVals, queryContext)
  }
  // delta shim addition end
